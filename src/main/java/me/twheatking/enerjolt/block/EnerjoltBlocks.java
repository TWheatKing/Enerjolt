...
public final class EnerjoltBlocks {
    ...
    public static final DeferredRegister.Blocks BLOCKS = DeferredRegister.createBlocks(EJOLTAPI.MOD_ID);
    ...
    private static DeferredItem<Item> createBlockItem(String name, DeferredBlock<? extends Block> blockRegistryObject, Item.Properties props) {
        return EnerjoltItems.ITEMS.register(name, () -> new BlockItem(blockRegistryObject.get(), props));
    }
    ...
    public static final DeferredItem<Item> BASIC_ITEM_CONVEYOR_BELT_ITEM = EnerjoltItems.ITEMS.register("item_conveyor_belt",
    ...
    public static final DeferredBlock<ItemConveyorBeltBlock> FAST_ITEM_CONVEYOR_BELT = BLOCKS.register("fast_item_conveyor_belt",
            () -> new ItemConveyorBeltBlock(ConveyorBeltTier.FAST, BlockBehaviour.Properties.of().noCollission().
                    strength(2.5f, 3.0f).sound(SoundType.METAL)));
    public static final DeferredItem<Item> FAST_ITEM_CONVEYOR_BELT_ITEM = EnerjoltItems.ITEMS.register("fast_item_conveyor_belt",
    ...
    public static final DeferredBlock<ItemConveyorBeltBlock> EXPRESS_ITEM_CONVEYOR_BELT = BLOCKS.register("express_item_conveyor_belt",
            () -> new ItemConveyorBeltBlock(ConveyorBeltTier.EXPRESS, BlockBehaviour.Properties.of().noCollission().
                    strength(2.5f, 3.0f).sound(SoundType.METAL)));
    public static final DeferredItem<Item> EXPRESS_ITEM_CONVEYOR_BELT_ITEM = EnerjoltItems.ITEMS.register("express_item_conveyor_belt",
    ...
    public static final DeferredItem<Item> IRON_FLUID_PIPE_ITEM = EnerjoltItems.ITEMS.register("fluid_pipe",
    ...
    public static final DeferredItem<Item> GOLDEN_FLUID_PIPE_ITEM = EnerjoltItems.ITEMS.register("golden_fluid_pipe",
    ...
    public static final DeferredItem<Item> FLUID_TANK_SMALL_ITEM = EnerjoltItems.ITEMS.register("fluid_tank_small",
    ...
    public static final DeferredItem<Item> FLUID_TANK_MEDIUM_ITEM = EnerjoltItems.ITEMS.register("fluid_tank_medium",
    ...
    public static final DeferredItem<Item> FLUID_TANK_LARGE_ITEM = EnerjoltItems.ITEMS.register("fluid_tank_large",
    ...
    public static final DeferredItem<Item> CREATIVE_FLUID_TANK_ITEM = EnerjoltItems.ITEMS.register("creative_fluid_tank",
    ...
    public static final DeferredItem<Item> ITEM_SILO_TINY_ITEM = EnerjoltItems.ITEMS.register("item_silo_tiny",
    ...
    public static final DeferredItem<Item> ITEM_SILO_SMALL_ITEM = EnerjoltItems.ITEMS.register("item_silo_small",
    ...
    public static final DeferredItem<Item> ITEM_SILO_MEDIUM_ITEM = EnerjoltItems.ITEMS.register("item_silo_medium",
    ...
    public static final DeferredItem<Item> ITEM_SILO_LARGE_ITEM = EnerjoltItems.ITEMS.register("item_silo_large",
    ...
    public static final DeferredItem<Item> ITEM_SILO_GIANT_ITEM = EnerjoltItems.ITEMS.register("item_silo_giant",
    ...
    public static final DeferredBlock<CreativeItemSiloBlock> CREATIVE_ITEM_SILO = BLOCKS.register("creative_item_silo",
            () -> new CreativeItemSiloBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_PURPLE).
                    requiresCorrectToolForDrops().strength(-1.f, 3600000.f).noLootTable()));
    public static final DeferredItem<Item> CREATIVE_ITEM_SILO_ITEM = EnerjoltItems.ITEMS.register("creative_item_silo",
    ...
    public static final DeferredItem<Item> TIN_CABLE_ITEM = EnerjoltItems.ITEMS.register("tin_cable",
    ...
    public static final DeferredItem<Item> COPPER_CABLE_ITEM = EnerjoltItems.ITEMS.register("copper_cable",
    ...
    public static final DeferredItem<Item> GOLD_CABLE_ITEM = EnerjoltItems.ITEMS.register("gold_cable",
    ...
    public static final DeferredItem<Item> ENERGIZED_COPPER_CABLE_ITEM = EnerjoltItems.ITEMS.register("energized_copper_cable",
    ...
    public static final DeferredItem<Item> ENERGIZED_GOLD_CABLE_ITEM = EnerjoltItems.ITEMS.register("energized_gold_cable",
    ...
    public static final DeferredItem<Item> ENERGIZED_CRYSTAL_MATRIX_CABLE_ITEM = EnerjoltItems.ITEMS.register("energized_crystal_matrix_cable",
    ...
    public static final DeferredItem<Item> LV_TRANSFORMER_1_TO_N_ITEM = EnerjoltItems.ITEMS.register("lv_transformer_1_to_n",
    ...
    public static final DeferredItem<Item> LV_TRANSFORMER_3_TO_3_ITEM = EnerjoltItems.ITEMS.register("lv_transformer_3_to_3",
    ...
    public static final DeferredItem<Item> LV_TRANSFORMER_N_TO_1_ITEM = EnerjoltItems.ITEMS.register("lv_transformer_n_to_1",
    ...
    public static final DeferredItem<Item> MV_TRANSFORMER_1_TO_N_ITEM = EnerjoltItems.ITEMS.register("transformer_1_to_n",
    ...
    public static final DeferredItem<Item> MV_TRANSFORMER_3_TO_3_ITEM = EnerjoltItems.ITEMS.register("transformer_3_to_3",
    ...
    public static final DeferredItem<Item> MV_TRANSFORMER_N_TO_1_ITEM = EnerjoltItems.ITEMS.register("transformer_n_to_1",
    ...
    public static final DeferredItem<Item> HV_TRANSFORMER_1_TO_N_ITEM = EnerjoltItems.ITEMS.register("hv_transformer_1_to_n",
    ...
    public static final DeferredItem<Item> HV_TRANSFORMER_3_TO_3_ITEM = EnerjoltItems.ITEMS.register("hv_transformer_3_to_3",
    ...
    public static final DeferredItem<Item> HV_TRANSFORMER_N_TO_1_ITEM = EnerjoltItems.ITEMS.register("hv_transformer_n_to_1",
    ...
    public static final DeferredItem<Item> EHV_TRANSFORMER_1_TO_N_ITEM = EnerjoltItems.ITEMS.register("ehv_transformer_1_to_n",
    ...
    public static final DeferredItem<Item> EHV_TRANSFORMER_3_TO_3_ITEM = EnerjoltItems.ITEMS.register("ehv_transformer_3_to_3",
    ...
    public static final DeferredItem<Item> EHV_TRANSFORMER_N_TO_1_ITEM = EnerjoltItems.ITEMS.register("ehv_transformer_n_to_1",
    ...
    private static DeferredItem<Item> createConfigurableTransformerBlockItem(String name, DeferredBlock<ConfigurableTransformerBlock> block) {
        return EnerjoltItems.ITEMS.register(name, () -> new ConfigurableTransformerBlock.Item(block.get(), new Item.Properties(), block.get().getTier()));
    }
    ...
    public static final DeferredBlock<Block> BATTERY_BOX = BLOCKS.register("battery_box",
            () -> new BatteryBoxBlock(BlockBehaviour.Properties.of().
                    requiresCorrectToolForDrops().strength(5.0f, 6.0f).sound(SoundType.METAL)));
    public static final DeferredItem<Item> BATTERY_BOX_ITEM = EnerjoltItems.ITEMS.register("battery_box",
    ...
    public static final DeferredBlock<Block> ADVANCED_BATTERY_BOX = BLOCKS.register("advanced_battery_box",
            () -> new AdvancedBatteryBoxBlock(BlockBehaviour.Properties.of().
                    requiresCorrectToolForDrops().strength(5.0f, 6.0f).sound(SoundType.METAL)));
    public static final DeferredItem<Item> ADVANCED_BATTERY_BOX_ITEM = EnerjoltItems.ITEMS.register("advanced_battery_box",
    ...
    public static final DeferredBlock<Block> CREATIVE_BATTERY_BOX = BLOCKS.register("creative_battery_box",
            () -> new CreativeBatteryBoxBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_PURPLE).
                    requiresCorrectToolForDrops().strength(-1.f, 3600000.f).noLootTable()));
    public static final DeferredItem<Item> CREATIVE_BATTERY_BOX_ITEM = EnerjoltItems.ITEMS.register("creative_battery_box",
    ...
    public static final DeferredBlock<Block> AUTO_CRAFTER = BLOCKS.register("auto_crafter",
            () -> new AutoCrafterBlock(BlockBehaviour.Properties.of().
                    requiresCorrectToolForDrops().strength(5.0f, 6.0f).sound(SoundType.METAL)));
    public static final DeferredItem<Item> AUTO_CRAFTER_ITEM = EnerjoltItems.ITEMS.register("auto_crafter",
    ...
    public static final DeferredBlock<Block> ADVANCED_AUTO_CRAFTER = BLOCKS.register("advanced_auto_crafter",
            () -> new AdvancedAutoCrafterBlock(BlockBehaviour.Properties.of().
                    requiresCorrectToolForDrops().strength(5.0f, 6.0f).sound(SoundType.METAL)));
    public static final DeferredItem<Item> ADVANCED_AUTO_CRAFTER_ITEM = EnerjoltItems.ITEMS.register("advanced_auto_crafter",
    ...
    public static final DeferredBlock<Block> ADVANCED_CRUSHER = BLOCKS.register("advanced_crusher",
            () -> new AdvancedCrusherBlock(BlockBehaviour.Properties.of().
                    requiresCorrectToolForDrops().strength(5.0f, 6.0f).sound(SoundType.METAL)));
    public static final DeferredItem<Item> ADVANCED_CRUSHER_ITEM = EnerjoltItems.ITEMS.register("advanced_crusher",
    ...
    public static final DeferredBlock<Block> ADVANCED_PULVERIZER = BLOCKS.register("advanced_pulverizer",
            () -> new AdvancedPulverizerBlock(BlockBehaviour.Properties.of().
                    requiresCorrectToolForDrops().strength(5.0f, 6.0f).sound(SoundType.METAL)));
    public static final DeferredItem<Item> ADVANCED_PULVERIZER_ITEM = EnerjoltItems.ITEMS.register("advanced_pulverizer",
    ...
    public static final DeferredBlock<Block> METAL_PRESS = BLOCKS.register("metal_press",
            () -> new MetalPressBlock(BlockBehaviour.Properties.of().
                    requiresCorrectToolForDrops().strength(5.0f, 6.0f).sound(SoundType.METAL)));
    public static final DeferredItem<Item> METAL_PRESS_ITEM = EnerjoltItems.ITEMS.register("metal_press",
    ...
    public static final DeferredBlock<Block> FILTRATION_PLANT = BLOCKS.register("filtration_plant",
            () -> new FiltrationPlantBlock(BlockBehaviour.Properties.of().
                    requiresCorrectToolForDrops().strength(5.0f, 6.0f).sound(SoundType.METAL)));
    public static final DeferredItem<Item> FILTRATION_PLANT_ITEM = EnerjoltItems.ITEMS.register("filtration_plant",
    ...
    public static final DeferredBlock<Block> DRAIN = BLOCKS.register("drain",
            () -> new DrainBlock(BlockBehaviour.Properties.of().
                    requiresCorrectToolForDrops().strength(5.0f, 6.0f).sound(SoundType.METAL)));
    public static final DeferredItem<Item> DRAIN_ITEM = EnerjoltItems.ITEMS.register("drain",
    ...
    public static final DeferredBlock<Block> CHARGER = BLOCKS.register("charger",
            () -> new ChargerBlock(BlockBehaviour.Properties.of().
                    requiresCorrectToolForDrops().strength(5.0f, 6.0f).sound(SoundType.METAL)));
    public static final DeferredItem<Item> CHARGER_ITEM = EnerjoltItems.ITEMS.register("charger",
    ...
    public static final DeferredBlock<Block> ADVANCED_CHARGER = BLOCKS.register("advanced_charger",
            () -> new AdvancedChargerBlock(BlockBehaviour.Properties.of().
                    requiresCorrectToolForDrops().strength(5.0f, 6.0f).sound(SoundType.METAL)));
    public static final DeferredItem<Item> ADVANCED_CHARGER_ITEM = EnerjoltItems.ITEMS.register("advanced_charger",
    ...
    public static final DeferredBlock<Block> MINECART_CHARGER = BLOCKS.register("minecart_charger",
            () -> new MinecartChargerBlock(BlockBehaviour.Properties.of().
                    requiresCorrectToolForDrops().strength(5.0f, 6.0f).sound(SoundType.METAL)));
    public static final DeferredItem<Item> MINECART_CHARGER_ITEM = EnerjoltItems.ITEMS.register("minecart_charger",
    ...
    public static final DeferredBlock<Block> ADVANCED_MINECART_CHARGER = BLOCKS.register("advanced_minecart_charger",
            () -> new AdvancedMinecartChargerBlock(BlockBehaviour.Properties.of().
                    requiresCorrectToolForDrops().strength(5.0f, 6.0f).sound(SoundType.METAL)));
    public static final DeferredItem<Item> ADVANCED_MINECART_CHARGER_ITEM = EnerjoltItems.ITEMS.register("advanced_minecart_charger",
    ...
    public static final DeferredBlock<Block> MINECART_UNCHARGER = BLOCKS.register("minecart_uncharger",
            () -> new MinecartUnchargerBlock(BlockBehaviour.Properties.of().
                    requiresCorrectToolForDrops().strength(5.0f, 6.0f).sound(SoundType.METAL)));
    public static final DeferredItem<Item> MINECART_UNCHARGER_ITEM = EnerjoltItems.ITEMS.register("minecart_uncharger",
    ...
    public static final DeferredBlock<Block> ADVANCED_MINECART_UNCHARGER = BLOCKS.register("advanced_minecart_uncharger",
            () -> new AdvancedMinecartUnchargerBlock(BlockBehaviour.Properties.of().
                    requiresCorrectToolForDrops().strength(5.0f, 6.0f).sound(SoundType.METAL)));
    public static final DeferredItem<Item> ADVANCED_MINECART_UNCHARGER_ITEM = EnerjoltItems.ITEMS.register("advanced_minecart_uncharger",
    ...
    private static DeferredItem<Item> createSolarPanelBlockItem(String name, DeferredBlock<SolarPanelBlock> blockRegistryObject) {
        return EnerjoltItems.ITEMS.register(name, () -> new SolarPanelBlock.Item(blockRegistryObject.get(), new Item.Properties(),
    ...
    public static final DeferredItem<Item> LIGHTNING_GENERATOR_ITEM = EnerjoltItems.ITEMS.register("lightning_generator",
    ...
    public static final DeferredItem<Item> CHARGING_STATION_ITEM = EnerjoltItems.ITEMS.register("charging_station",
    ...
    public static final DeferredBlock<Block> TELEPORTER = BLOCKS.register("teleporter",
            () -> new TeleporterBlock(BlockBehaviour.Properties.of().
                    requiresCorrectToolForDrops().strength(5.0f, 6.0f).sound(SoundType.METAL)));
    public static final DeferredItem<Item> TELEPORTER_ITEM = EnerjoltItems.ITEMS.register("teleporter",
