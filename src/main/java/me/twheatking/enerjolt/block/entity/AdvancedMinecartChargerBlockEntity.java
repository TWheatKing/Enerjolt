...
import me.twheatking.enerjolt.block.AdvancedMinecartChargerBlock;
...
import me.twheatking.enerjolt.screen.AdvancedMinecartChargerMenu;
...
public class AdvancedMinecartChargerBlockEntity extends MenuEnergyStorageBlockEntity<ReceiveOnlyEnergyStorage> {
    ...
    public AdvancedMinecartChargerBlockEntity(BlockPos blockPos, BlockState blockState) {
        super(
                EnerjoltBlockEntities.ADVANCED_MINECART_CHARGER_ENTITY.get(), blockPos, blockState,
