...
import me.twheatking.enerjolt.screen.AdvancedPulverizerMenu;
...
public class AdvancedPulverizerBlockEntity
        extends SimpleRecipeFluidMachineBlockEntity<EnerjoltFluidStorage, RecipeInput, PulverizerRecipe> {
    ...
    public AdvancedPulverizerBlockEntity(BlockPos blockPos, BlockState blockState) {
        super(
                EnerjoltBlockEntities.ADVANCED_PULVERIZER_ENTITY.get(), blockPos, blockState,

                "advanced_pulverizer", AdvancedPulverizerMenu::new,

                3, EnerjoltRecipes.PULVERIZER_TYPE.get(), ModConfigs.COMMON_ADVANCED_PULVERIZER_RECIPE_DURATION.getValue(),
