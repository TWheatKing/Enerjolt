...
import me.twheatking.enerjolt.block.entity.base.SelectableRecipeMachineBlockEntity;
...
import me.twheatking.enerjolt.screen.AutoPressMoldMakerMenu;
...
public class AutoPressMoldMakerBlockEntity
    ...
    public AutoPressMoldMakerBlockEntity(BlockPos blockPos, BlockState blockState) {
        super(
                EnerjoltBlockEntities.AUTO_PRESS_MOLD_MAKER_ENTITY.get(), blockPos, blockState,

                "auto_press_mold_maker", AutoPressMoldMakerMenu::new,

                3,
                EnerjoltRecipes.PRESS_MOLD_MAKER_TYPE.get(),
                EnerjoltRecipes.PRESS_MOLD_MAKER_SERIALIZER.get(),
