...
import me.twheatking.enerjolt.inventory.InfiniteSingleItemStackHandler;
import me.twheatking.enerjolt.screen.CreativeItemSiloMenu;
...
public class CreativeItemSiloBlockEntity
    ...
    public CreativeItemSiloBlockEntity(BlockPos blockPos, BlockState blockState) {
        super(
               EnerjoltBlockEntities.CREATIVE_ITEM_SILO_ENTITY.get(), blockPos, blockState,
