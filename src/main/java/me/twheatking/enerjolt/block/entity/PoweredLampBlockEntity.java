...
import me.twheatking.enerjolt.block.PoweredLampBlock;
import me.twheatking.enerjolt.block.entity.base.EnergyStorageBlockEntity;
...
public class PoweredLampBlockEntity extends EnergyStorageBlockEntity<ReceiveOnlyEnergyStorage> {
    ...
    public PoweredLampBlockEntity(BlockPos blockPos, BlockState blockState) {
        super(
                EnerjoltBlockEntities.POWERED_LAMP_ENTITY.get(), blockPos, blockState,
