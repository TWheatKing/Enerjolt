...
import me.twheatking.enerjolt.block.FluidTankBlock;
import me.twheatking.enerjolt.block.entity.AbstractFluidTankBlockEntity;
    ...
    public void render(AbstractFluidTankBlockEntity<?> blockEntity, float partialTick, PoseStack poseStack,
        ...
        //Indicator bar
        {
            TextureAtlasSprite indicatorBarSprite = Minecraft.getInstance().getTextureAtlas(InventoryMenu.BLOCK_ATLAS).
                    apply(EJOLTAPI.id("block/fluid_tank_indicator_bar"));
