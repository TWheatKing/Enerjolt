package me.twheatking.enerjolt.config;

import com.mojang.logging.LogUtils;
import me.twheatking.enerjolt.block.CableBlock;
import me.twheatking.enerjolt.config.validation.ValueValidators;
import me.twheatking.enerjolt.config.value.*;
...
public final class ModConfigs {
    ...
    public static final Config COMMON_CONFIG = new Config(getRelativeConfigFile("common.conf"),
            "Enerjolt Common Config (IMPORTANT: Not all values are synced from the server to the client.)");
