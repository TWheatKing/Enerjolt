...
import me.twheatking.enerjolt.datagen.generators.PageContent;
import me.twheatking.enerjolt.datagen.generators.PageContentProvider;
...
public class ModBookPageContentProvider extends PageContentProvider {
    ...
    private void registerResourcesChapter() {
        ...
        addSimplePage(pageId("fertilizers"), Component.empty().append(
                ...
                EJOLTAPI.id("textures/item/good_fertilizer.png"),
                EJOLTAPI.id("textures/item/advanced_fertilizer.png")
        });
        ...
        addSimplePage(pageId("ore_dusts"), Component.empty().append(
                ...
                EJOLTAPI.id("textures/item/copper_dust.png"),
                EJOLTAPI.id("textures/item/iron_dust.png"),
                EJOLTAPI.id("textures/item/gold_dust.png")
        });
        ...
        addSimplePage(pageId("plates"), Component.empty().append(
                ...
                EJOLTAPI.id("textures/item/copper_plate.png"),
                EJOLTAPI.id("textures/item/iron_plate.png"),
                EJOLTAPI.id("textures/item/gold_plate.png"),
                EJOLTAPI.id("textures/item/advanced_alloy_plate.png"),
                EJOLTAPI.id("textures/item/energized_copper_plate.png"),
                EJOLTAPI.id("textures/item/energized_gold_plate.png")
        });
        ...
        addSimplePage(pageId("alloys"), Component.empty().append(
                ...
                EJOLTAPI.id("textures/item/redstone_alloy_ingot.png"),
                EJOLTAPI.id("textures/item/advanced_alloy_ingot.png")
        });
        ...
        addSimplePage(pageId("metal_products"), Component.empty().append(
                ...
                EJOLTAPI.id("textures/item/iron_rod.png"),
                EJOLTAPI.id("textures/item/tin_wire.png"),
                EJOLTAPI.id("textures/item/copper_wire.png"),
                EJOLTAPI.id("textures/item/gold_wire.png"),
                EJOLTAPI.id("textures/item/energized_copper_wire.png"),
                EJOLTAPI.id("textures/item/energized_gold_wire.png")
        });
        ...
        addSimplePage(pageId("circuits"), Component.empty().append(
                ...
                EJOLTAPI.id("textures/item/advanced_circuit.png"),
                EJOLTAPI.id("textures/item/processing_unit.png"),
                EJOLTAPI.id("textures/item/teleporter_processing_unit.png")
        });
    ...
    private void registerUpgradesChapter() {
        ...
        addSimplePage(pageId("speed_upgrades"), Component.empty().append(
                ...
                EJOLTAPI.id("textures/item/speed_upgrade_module_1.png"),
                EJOLTAPI.id("textures/item/speed_upgrade_module_2.png"),
                EJOLTAPI.id("textures/item/speed_upgrade_module_3.png"),
                EJOLTAPI.id("textures/item/speed_upgrade_module_4.png"),
                EJOLTAPI.id("textures/item/speed_upgrade_module_5.png")
        });
        ...
        addSimplePage(pageId("energy_efficiency_upgrades"), Component.empty().append(
                ...
                EJOLTAPI.id("textures/item/energy_efficiency_upgrade_module_2.png"),
                EJOLTAPI.id("textures/item/energy_efficiency_upgrade_module_3.png"),
                EJOLTAPI.id("textures/item/energy_efficiency_upgrade_module_4.png"),
                EJOLTAPI.id("textures/item/energy_efficiency_upgrade_module_5.png")
        });
        ...
        addSimplePage(pageId("energy_capacity_upgrades"), Component.empty().append(
                ...
                EJOLTAPI.id("textures/item/energy_capacity_upgrade_module_2.png"),
                EJOLTAPI.id("textures/item/energy_capacity_upgrade_module_3.png"),
                EJOLTAPI.id("textures/item/energy_capacity_upgrade_module_4.png"),
                EJOLTAPI.id("textures/item/energy_capacity_upgrade_module_5.png")
        });
        ...
        addSimplePage(pageId("duration_upgrades"), Component.empty().append(
                ...
                EJOLTAPI.id("textures/item/duration_upgrade_module_2.png"),
                EJOLTAPI.id("textures/item/duration_upgrade_module_3.png"),
                EJOLTAPI.id("textures/item/duration_upgrade_module_4.png"),
                EJOLTAPI.id("textures/item/duration_upgrade_module_5.png"),
                EJOLTAPI.id("textures/item/duration_upgrade_module_6.png")
        });
        ...
        addSimplePage(pageId("range_upgrades"), Component.empty().append(
                ...
                EJOLTAPI.id("textures/item/range_upgrade_module_2.png"),
                EJOLTAPI.id("textures/item/range_upgrade_module_3.png")
        });
        ...
        addSimplePage(pageId("extraction_depth_upgrades"), Component.empty().append(
                ...
                EJOLTAPI.id("textures/item/extraction_depth_upgrade_module_2.png"),
                EJOLTAPI.id("textures/item/extraction_depth_upgrade_module_3.png"),
                EJOLTAPI.id("textures/item/extraction_depth_upgrade_module_4.png"),
                EJOLTAPI.id("textures/item/extraction_depth_upgrade_module_5.png")
        });
        ...
        addSimplePage(pageId("extraction_range_upgrades"), Component.empty().append(
                ...
                EJOLTAPI.id("textures/item/extraction_range_upgrade_module_2.png"),
                EJOLTAPI.id("textures/item/extraction_range_upgrade_module_3.png"),
                EJOLTAPI.id("textures/item/extraction_range_upgrade_module_4.png"),
                EJOLTAPI.id("textures/item/extraction_range_upgrade_module_5.png")
        });
        ...
        addSimplePage(pageId("furnace_mode_upgrades"), Component.empty().append(
                ...
                EJOLTAPI.id("textures/item/smoker_upgrade_module.png")
        });
        ...
        addSimplePage(pageId("moon_light_upgrades"), Component.empty().append(
                ...
                EJOLTAPI.id("textures/item/moon_light_upgrade_module_2.png"),
                EJOLTAPI.id("textures/item/moon_light_upgrade_module_3.png")
        });
    }
    private void registerToolsChapter() {
        ...
        PageContent toolsChapterPage = addChapterPage(pageId("tools_chapter"),
                ...
                Component.empty().append(
                        ...
                        Component.literal("\n\n").
                                withStyle(ChatFormatting.BLACK, ChatFormatting.BOLD).withStyle(UNIFORM).
                                append(backToTableOfContentComponent(mainTableOfContentPageId))
                ), EJOLTAPI.id("textures/item/stone_hammer.png"));
        ...
        addSimplePage(pageId("hammers"), Component.empty().append(
                ...
                EJOLTAPI.id("textures/item/stone_hammer.png"),
                EJOLTAPI.id("textures/item/iron_hammer.png"),
                EJOLTAPI.id("textures/item/golden_hammer.png"),
                EJOLTAPI.id("textures/item/diamond_hammer.png"),
                EJOLTAPI.id("textures/item/netherite_hammer.png")
        });
    ...
    private void registerEnergyItemsChapter() {
        ...
        addSimplePage(pageId("batteries"), Component.empty().append(
                ...
                EJOLTAPI.id("textures/item/battery_2.png"),
                EJOLTAPI.id("textures/item/battery_3.png"),
                EJOLTAPI.id("textures/item/battery_4.png"),
                EJOLTAPI.id("textures/item/battery_5.png"),
                EJOLTAPI.id("textures/item/battery_6.png"),
                EJOLTAPI.id("textures/item/battery_7.png"),
                EJOLTAPI.id("textures/item/battery_8.png")
        });
    }
    ...
    private void registerEnergyBlocksChapterEnergyTransportationSubChapter() {
        ...
        addSimplePage(pageId("cables"), Component.empty().append(
                ...
                EnerjoltBlocks.COPPER_CABLE.get(),
                EnerjoltBlocks.GOLD_CABLE.get(),
                EnerjoltBlocks.ENERGIZED_COPPER_CABLE.get(),
                EnerjoltBlocks.ENERGIZED_GOLD_CABLE.get(),
                EnerjoltBlocks.ENERGIZED_CRYSTAL_MATRIX_CABLE.get()
        });
    ...
    private void registerEnergyBlocksChapterEnergyProductionSubChapter() {
        ...
        addSimplePage(pageId("solar_cells"), Component.empty().append(
                ...
                EJOLTAPI.id("textures/item/advanced_solar_cell.png"),
                EJOLTAPI.id("textures/item/reinforced_advanced_solar_cell.png")
        });
    ...
    private void registerMachineConfigurationChapter() {
        ...
        addSimplePage(pageId("redstone_mode_configuration"), Component.empty().append(
                ...
                EJOLTAPI.id("textures/gui/book_icons/redstone_mode_ignore.png"),
                EJOLTAPI.id("textures/gui/book_icons/redstone_mode_high.png"),
                EJOLTAPI.id("textures/gui/book_icons/redstone_mode_low.png")
        });
        ...
        addSimplePage(pageId("comparator_mode_configuration"), Component.empty().append(
                ...
                EJOLTAPI.id("textures/gui/book_icons/comparator_mode_item.png"),
                EJOLTAPI.id("textures/gui/book_icons/comparator_mode_fluid.png"),
                EJOLTAPI.id("textures/gui/book_icons/comparator_mode_energy.png")
        });
    }
    private void registerEntitiesChapter() {
        ...
        addSimplePage(pageId("battery_box_minecarts"), Component.empty().append(
                ...
                EJOLTAPI.id("textures/item/advanced_battery_box_minecart.png")
        });
    }
