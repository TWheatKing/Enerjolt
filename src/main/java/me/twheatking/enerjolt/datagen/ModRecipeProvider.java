...
import me.twheatking.enerjolt.recipe.*;
...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    private void buildItemIngredientsCraftingRecipes(RecipeOutput output) {
        add3x3UnpackingCraftingRecipe(output, has(EnerjoltBlocks.SAWDUST_BLOCK),
                Ingredient.of(EnerjoltBlocks.SAWDUST_BLOCK), EnerjoltItems.SAWDUST,
                CraftingBookCategory.MISC, "", "_from_sawdust_block");
        add3x3PackingCraftingRecipe(output, has(CommonItemTags.DUSTS_WOOD),
                Ingredient.of(CommonItemTags.DUSTS_WOOD), EnerjoltBlocks.SAWDUST_BLOCK_ITEM,
                CraftingBookCategory.MISC, "", "");

        add3x3UnpackingCraftingRecipe(output, has(CommonItemTags.STORAGE_BLOCKS_SILICON),
                Ingredient.of(CommonItemTags.STORAGE_BLOCKS_SILICON), EnerjoltItems.SILICON,
                CraftingBookCategory.MISC, "", "_from_silicon_block");
        add3x3PackingCraftingRecipe(output, has(CommonItemTags.SILICON),
                Ingredient.of(CommonItemTags.SILICON), EnerjoltBlocks.SILICON_BLOCK_ITEM,
                CraftingBookCategory.MISC, "", "");

        addMetalNuggetCraftingRecipe(output, CommonItemTags.INGOTS_TIN, EnerjoltItems.TIN_NUGGET);
        addMetalIngotCraftingRecipes(output, CommonItemTags.NUGGETS_TIN, CommonItemTags.STORAGE_BLOCKS_TIN,
                EnerjoltItems.TIN_INGOT, "tin");

        add3x3PackingCraftingRecipe(output, has(CommonItemTags.INGOTS_TIN),
                Ingredient.of(CommonItemTags.INGOTS_TIN), EnerjoltBlocks.TIN_BLOCK_ITEM,
                CraftingBookCategory.MISC, "", "");

        add3x3UnpackingCraftingRecipe(output, has(CommonItemTags.STORAGE_BLOCKS_RAW_TIN),
                Ingredient.of(CommonItemTags.STORAGE_BLOCKS_RAW_TIN), EnerjoltItems.RAW_TIN,
                CraftingBookCategory.MISC, "", "");
        add3x3PackingCraftingRecipe(output, has(CommonItemTags.RAW_MATERIALS_TIN),
                Ingredient.of(CommonItemTags.RAW_MATERIALS_TIN), EnerjoltBlocks.RAW_TIN_BLOCK_ITEM,
                CraftingBookCategory.MISC, "", "");

        addMetalPlateCraftingRecipe(output, CommonItemTags.INGOTS_TIN, EnerjoltItems.TIN_PLATE);
        addMetalPlateCraftingRecipe(output, Tags.Items.INGOTS_COPPER, EnerjoltItems.COPPER_PLATE);
        addMetalPlateCraftingRecipe(output, Tags.Items.INGOTS_IRON, EnerjoltItems.IRON_PLATE);
        addMetalPlateCraftingRecipe(output, Tags.Items.INGOTS_GOLD, EnerjoltItems.GOLD_PLATE);

        addMetalWireCraftingRecipe(output, CommonItemTags.PLATES_TIN, EnerjoltItems.TIN_WIRE);
        addMetalWireCraftingRecipe(output, CommonItemTags.PLATES_COPPER, EnerjoltItems.COPPER_WIRE);
        addMetalWireCraftingRecipe(output, CommonItemTags.PLATES_GOLD, EnerjoltItems.GOLD_WIRE);
        ...
        addShapedCraftingRecipe(output, has(CommonItemTags.SILICON), Map.of(
                ...
                "SQS",
                " T "
        }, new ItemStack(EnerjoltItems.BASIC_SOLAR_CELL.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(CommonItemTags.WIRES_COPPER), Map.of(
                ...
                "CIC",
                "SCS"
        }, new ItemStack(EnerjoltItems.BASIC_CIRCUIT.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.BASIC_CIRCUIT), Map.of(
                'G', Ingredient.of(CommonItemTags.WIRES_GOLD),
                'C', Ingredient.of(CommonItemTags.PLATES_COPPER),
                'B', Ingredient.of(EnerjoltItems.BASIC_CIRCUIT)
        ), new String[] {
                "GGG",
                "CBC",
                "CBC"
        }, new ItemStack(EnerjoltItems.BASIC_UPGRADE_MODULE.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.ADVANCED_CIRCUIT), Map.of(
                'G', Ingredient.of(CommonItemTags.WIRES_ENERGIZED_GOLD),
                'C', Ingredient.of(CommonItemTags.PLATES_ENERGIZED_COPPER),
                'A', Ingredient.of(EnerjoltItems.ADVANCED_CIRCUIT),
                'B', Ingredient.of(EnerjoltItems.BASIC_UPGRADE_MODULE)
        ), new String[] {
                "GGG",
                "CBC",
                "CAC"
        }, new ItemStack(EnerjoltItems.ADVANCED_UPGRADE_MODULE.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.REINFORCED_ADVANCED_UPGRADE_MODULE), Map.of(
                'g', Ingredient.of(CommonItemTags.WIRES_ENERGIZED_GOLD),
                'G', Ingredient.of(CommonItemTags.PLATES_ENERGIZED_GOLD),
                'P', Ingredient.of(EnerjoltItems.PROCESSING_UNIT),
                'A', Ingredient.of(EnerjoltItems.ADVANCED_UPGRADE_MODULE)
        ), new String[] {
                "ggg",
                "GAG",
                "GPG"
        }, new ItemStack(EnerjoltItems.REINFORCED_ADVANCED_UPGRADE_MODULE.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(Tags.Items.INGOTS_IRON), Map.of(
                ...
                "iIi",
                " i "
        }, new ItemStack(EnerjoltItems.SAW_BLADE.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(CommonItemTags.SILICON), Map.of(
                ...
                "ISI",
                "CIC"
        }, new ItemStack(EnerjoltBlocks.BASIC_MACHINE_FRAME_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(CommonItemTags.GEARS_IRON), Map.of(
                ...
                'B', Ingredient.of(EnerjoltBlocks.BASIC_MACHINE_FRAME_ITEM)
        ), new String[] {
                "IsR",
                "SBS",
                "RsI"
        }, new ItemStack(EnerjoltBlocks.HARDENED_MACHINE_FRAME_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(CommonItemTags.INGOTS_ENERGIZED_COPPER), Map.of(
                ...
                'H', Ingredient.of(EnerjoltBlocks.HARDENED_MACHINE_FRAME_ITEM)
        ), new String[] {
                "ESE",
                "AHA",
                "ESE"
        }, new ItemStack(EnerjoltBlocks.ADVANCED_MACHINE_FRAME_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.ENERGIZED_CRYSTAL_MATRIX), Map.of(
                'S', Ingredient.of(CommonItemTags.STORAGE_BLOCKS_SILICON),
                'C', Ingredient.of(EnerjoltItems.ENERGIZED_CRYSTAL_MATRIX),
                'A', Ingredient.of(EnerjoltBlocks.ADVANCED_MACHINE_FRAME_ITEM)
        ), new String[] {
                "CSC",
                "SAS",
                "CSC"
        }, new ItemStack(EnerjoltBlocks.REINFORCED_ADVANCED_MACHINE_FRAME_ITEM.get()), CraftingBookCategory.MISC);
    }
    private void buildFertilizerCraftingRecipes(RecipeOutput output) {
        addShapedCraftingRecipe(output, has(Items.BONE_MEAL), Map.of(
                ...
                "BLB",
                "ABP"
        }, new ItemStack(EnerjoltItems.BASIC_FERTILIZER.get(), 4), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.BASIC_FERTILIZER), Map.of(
                'B', Ingredient.of(EnerjoltItems.BASIC_FERTILIZER),
                ...
                "BsB",
                "bBW"
        }, new ItemStack(EnerjoltItems.GOOD_FERTILIZER.get(), 4), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.GOOD_FERTILIZER), Map.of(
                'G', Ingredient.of(EnerjoltItems.GOOD_FERTILIZER),
                ...
                "GrG",
                "TGR"
        }, new ItemStack(EnerjoltItems.ADVANCED_FERTILIZER.get(), 4), CraftingBookCategory.MISC);
    }
    private void buildUpgradeModuleCraftingRecipes(RecipeOutput output) {
        addShapedCraftingRecipe(output, has(EnerjoltItems.BASIC_UPGRADE_MODULE), Map.of(
                'C', Ingredient.of(CommonItemTags.PLATES_COPPER),
                'S', Ingredient.of(CommonItemTags.SILICON),
                'R', Ingredient.of(Tags.Items.DUSTS_REDSTONE),
                'B', Ingredient.of(EnerjoltItems.BASIC_UPGRADE_MODULE)
                ...
                "RBR",
                "CSC"
        }, new ItemStack(EnerjoltItems.SPEED_UPGRADE_MODULE_1.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.SPEED_UPGRADE_MODULE_1), Map.of(
                'C', Ingredient.of(CommonItemTags.PLATES_COPPER),
                'S', Ingredient.of(CommonItemTags.SILICON),
                'R', Ingredient.of(Tags.Items.DUSTS_REDSTONE),
                'B', Ingredient.of(EnerjoltItems.BASIC_UPGRADE_MODULE),
                's', Ingredient.of(EnerjoltItems.SPEED_UPGRADE_MODULE_1)
        ), new String[] {
                "CSC",
                "RBR",
                "CsC"
        }, new ItemStack(EnerjoltItems.SPEED_UPGRADE_MODULE_2.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.SPEED_UPGRADE_MODULE_2), Map.of(
                'C', Ingredient.of(CommonItemTags.PLATES_COPPER),
                'S', Ingredient.of(CommonItemTags.SILICON),
                'R', Ingredient.of(Tags.Items.DUSTS_REDSTONE),
                'A', Ingredient.of(EnerjoltItems.ADVANCED_UPGRADE_MODULE),
                's', Ingredient.of(EnerjoltItems.SPEED_UPGRADE_MODULE_2)
        ), new String[] {
                "CSC",
                "RAR",
                "CsC"
        }, new ItemStack(EnerjoltItems.SPEED_UPGRADE_MODULE_3.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.SPEED_UPGRADE_MODULE_3), Map.of(
                'C', Ingredient.of(CommonItemTags.PLATES_COPPER),
                'S', Ingredient.of(CommonItemTags.SILICON),
                'R', Ingredient.of(Tags.Items.DUSTS_REDSTONE),
                'A', Ingredient.of(EnerjoltItems.ADVANCED_UPGRADE_MODULE),
                's', Ingredient.of(EnerjoltItems.SPEED_UPGRADE_MODULE_3)
        ), new String[] {
                "CSC",
                "RAR",
                "CsC"
        }, new ItemStack(EnerjoltItems.SPEED_UPGRADE_MODULE_4.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.SPEED_UPGRADE_MODULE_4), Map.of(
                'C', Ingredient.of(CommonItemTags.PLATES_COPPER),
                'S', Ingredient.of(CommonItemTags.SILICON),
                'r', Ingredient.of(Tags.Items.DUSTS_REDSTONE),
                'R', Ingredient.of(EnerjoltItems.REINFORCED_ADVANCED_UPGRADE_MODULE),
                's', Ingredient.of(EnerjoltItems.SPEED_UPGRADE_MODULE_4)
        ), new String[] {
                "CSC",
                "rRr",
                "CsC"
        }, new ItemStack(EnerjoltItems.SPEED_UPGRADE_MODULE_5.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltItems.BASIC_UPGRADE_MODULE), Map.of(
                ...
                "RBR",
                "CGC"
        }, new ItemStack(EnerjoltItems.ENERGY_EFFICIENCY_UPGRADE_MODULE_1.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.ENERGY_EFFICIENCY_UPGRADE_MODULE_1), Map.of(
                'C', Ingredient.of(CommonItemTags.PLATES_COPPER),
                'G', Ingredient.of(Tags.Items.INGOTS_GOLD),
                'R', Ingredient.of(CommonItemTags.INGOTS_REDSTONE_ALLOY),
                'B', Ingredient.of(EnerjoltItems.BASIC_UPGRADE_MODULE),
                'E', Ingredient.of(EnerjoltItems.ENERGY_EFFICIENCY_UPGRADE_MODULE_1)
        ), new String[] {
                "CGC",
                "RBR",
                "CEC"
        }, new ItemStack(EnerjoltItems.ENERGY_EFFICIENCY_UPGRADE_MODULE_2.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.ENERGY_EFFICIENCY_UPGRADE_MODULE_2), Map.of(
                'C', Ingredient.of(CommonItemTags.PLATES_COPPER),
                'G', Ingredient.of(Tags.Items.INGOTS_GOLD),
                'R', Ingredient.of(CommonItemTags.INGOTS_REDSTONE_ALLOY),
                'A', Ingredient.of(EnerjoltItems.ADVANCED_UPGRADE_MODULE),
                'E', Ingredient.of(EnerjoltItems.ENERGY_EFFICIENCY_UPGRADE_MODULE_2)
        ), new String[] {
                "CGC",
                "RAR",
                "CEC"
        }, new ItemStack(EnerjoltItems.ENERGY_EFFICIENCY_UPGRADE_MODULE_3.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.ENERGY_EFFICIENCY_UPGRADE_MODULE_3), Map.of(
                'C', Ingredient.of(CommonItemTags.PLATES_COPPER),
                'G', Ingredient.of(Tags.Items.INGOTS_GOLD),
                'R', Ingredient.of(CommonItemTags.INGOTS_REDSTONE_ALLOY),
                'A', Ingredient.of(EnerjoltItems.ADVANCED_UPGRADE_MODULE),
                'E', Ingredient.of(EnerjoltItems.ENERGY_EFFICIENCY_UPGRADE_MODULE_3)
        ), new String[] {
                "CGC",
                "RAR",
                "CEC"
        }, new ItemStack(EnerjoltItems.ENERGY_EFFICIENCY_UPGRADE_MODULE_4.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.ENERGY_EFFICIENCY_UPGRADE_MODULE_4), Map.of(
                'C', Ingredient.of(CommonItemTags.PLATES_COPPER),
                'G', Ingredient.of(Tags.Items.INGOTS_GOLD),
                'r', Ingredient.of(CommonItemTags.INGOTS_REDSTONE_ALLOY),
                'R', Ingredient.of(EnerjoltItems.REINFORCED_ADVANCED_UPGRADE_MODULE),
                'E', Ingredient.of(EnerjoltItems.ENERGY_EFFICIENCY_UPGRADE_MODULE_4)
        ), new String[] {
                "CGC",
                "rRr",
                "CEC"
        }, new ItemStack(EnerjoltItems.ENERGY_EFFICIENCY_UPGRADE_MODULE_5.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltItems.BASIC_UPGRADE_MODULE), Map.of(
                ...
                "cBc",
                "CTC"
        }, new ItemStack(EnerjoltItems.ENERGY_CAPACITY_UPGRADE_MODULE_1.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.ENERGY_CAPACITY_UPGRADE_MODULE_1), Map.of(
                'C', Ingredient.of(CommonItemTags.PLATES_COPPER),
                'T', Ingredient.of(CommonItemTags.PLATES_TIN),
                'c', Ingredient.of(ItemTags.COALS),
                'B', Ingredient.of(EnerjoltItems.BASIC_UPGRADE_MODULE),
                'E', Ingredient.of(EnerjoltItems.ENERGY_CAPACITY_UPGRADE_MODULE_1)
        ), new String[] {
                "CTC",
                "cBc",
                "CEC"
        }, new ItemStack(EnerjoltItems.ENERGY_CAPACITY_UPGRADE_MODULE_2.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.ENERGY_CAPACITY_UPGRADE_MODULE_2), Map.of(
                'C', Ingredient.of(CommonItemTags.PLATES_COPPER),
                'T', Ingredient.of(CommonItemTags.PLATES_TIN),
                'c', Ingredient.of(ItemTags.COALS),
                'A', Ingredient.of(EnerjoltItems.ADVANCED_UPGRADE_MODULE),
                'E', Ingredient.of(EnerjoltItems.ENERGY_CAPACITY_UPGRADE_MODULE_2)
        ), new String[] {
                "CTC",
                "cAc",
                "CEC"
        }, new ItemStack(EnerjoltItems.ENERGY_CAPACITY_UPGRADE_MODULE_3.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.ENERGY_CAPACITY_UPGRADE_MODULE_3), Map.of(
                'C', Ingredient.of(CommonItemTags.PLATES_COPPER),
                'T', Ingredient.of(CommonItemTags.PLATES_TIN),
                'c', Ingredient.of(ItemTags.COALS),
                'A', Ingredient.of(EnerjoltItems.ADVANCED_UPGRADE_MODULE),
                'E', Ingredient.of(EnerjoltItems.ENERGY_CAPACITY_UPGRADE_MODULE_3)
        ), new String[] {
                "CTC",
                "cAc",
                "CEC"
        }, new ItemStack(EnerjoltItems.ENERGY_CAPACITY_UPGRADE_MODULE_4.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.ENERGY_CAPACITY_UPGRADE_MODULE_4), Map.of(
                'C', Ingredient.of(CommonItemTags.PLATES_COPPER),
                'T', Ingredient.of(CommonItemTags.PLATES_TIN),
                'c', Ingredient.of(ItemTags.COALS),
                'R', Ingredient.of(EnerjoltItems.REINFORCED_ADVANCED_UPGRADE_MODULE),
                'E', Ingredient.of(EnerjoltItems.ENERGY_CAPACITY_UPGRADE_MODULE_4)
        ), new String[] {
                "CTC",
                "cRc",
                "CEC"
        }, new ItemStack(EnerjoltItems.ENERGY_CAPACITY_UPGRADE_MODULE_5.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltItems.REINFORCED_ADVANCED_UPGRADE_MODULE), Map.of(
                ...
                "rRr",
                "GCG"
        }, new ItemStack(EnerjoltItems.DURATION_UPGRADE_MODULE_1.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.DURATION_UPGRADE_MODULE_1), Map.of(
                'G', Ingredient.of(CommonItemTags.PLATES_ENERGIZED_GOLD),
                'C', Ingredient.of(EnerjoltItems.ENERGIZED_CRYSTAL_MATRIX),
                'r', Ingredient.of(Tags.Items.DUSTS_REDSTONE),
                'R', Ingredient.of(EnerjoltItems.REINFORCED_ADVANCED_UPGRADE_MODULE),
                'D', Ingredient.of(EnerjoltItems.DURATION_UPGRADE_MODULE_1)
        ), new String[] {
                "GCG",
                "rRr",
                "GDG"
        }, new ItemStack(EnerjoltItems.DURATION_UPGRADE_MODULE_2.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.DURATION_UPGRADE_MODULE_2), Map.of(
                'G', Ingredient.of(CommonItemTags.PLATES_ENERGIZED_GOLD),
                'C', Ingredient.of(EnerjoltItems.ENERGIZED_CRYSTAL_MATRIX),
                'r', Ingredient.of(Tags.Items.DUSTS_REDSTONE),
                'R', Ingredient.of(EnerjoltItems.REINFORCED_ADVANCED_UPGRADE_MODULE),
                'D', Ingredient.of(EnerjoltItems.DURATION_UPGRADE_MODULE_2)
        ), new String[] {
                "GCG",
                "rRr",
                "GDG"
        }, new ItemStack(EnerjoltItems.DURATION_UPGRADE_MODULE_3.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.DURATION_UPGRADE_MODULE_3), Map.of(
                'G', Ingredient.of(CommonItemTags.PLATES_ENERGIZED_GOLD),
                'C', Ingredient.of(EnerjoltItems.ENERGIZED_CRYSTAL_MATRIX),
                'r', Ingredient.of(Tags.Items.DUSTS_REDSTONE),
                'R', Ingredient.of(EnerjoltItems.REINFORCED_ADVANCED_UPGRADE_MODULE),
                'D', Ingredient.of(EnerjoltItems.DURATION_UPGRADE_MODULE_3)
        ), new String[] {
                "GCG",
                "rRr",
                "GDG"
        }, new ItemStack(EnerjoltItems.DURATION_UPGRADE_MODULE_4.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.DURATION_UPGRADE_MODULE_4), Map.of(
                'G', Ingredient.of(CommonItemTags.PLATES_ENERGIZED_GOLD),
                'C', Ingredient.of(EnerjoltItems.ENERGIZED_CRYSTAL_MATRIX),
                'r', Ingredient.of(Tags.Items.DUSTS_REDSTONE),
                'R', Ingredient.of(EnerjoltItems.REINFORCED_ADVANCED_UPGRADE_MODULE),
                'D', Ingredient.of(EnerjoltItems.DURATION_UPGRADE_MODULE_4)
        ), new String[] {
                "GCG",
                "rRr",
                "GDG"
        }, new ItemStack(EnerjoltItems.DURATION_UPGRADE_MODULE_5.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.DURATION_UPGRADE_MODULE_5), Map.of(
                'G', Ingredient.of(CommonItemTags.PLATES_ENERGIZED_GOLD),
                'C', Ingredient.of(EnerjoltItems.ENERGIZED_CRYSTAL_MATRIX),
                'R', Ingredient.of(EnerjoltItems.REINFORCED_ADVANCED_UPGRADE_MODULE),
                'D', Ingredient.of(EnerjoltItems.DURATION_UPGRADE_MODULE_5)
        ), new String[] {
                "GDG",
                "CRC",
                "GDG"
        }, new ItemStack(EnerjoltItems.DURATION_UPGRADE_MODULE_6.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.ADVANCED_UPGRADE_MODULE), Map.of(
                'G', Ingredient.of(CommonItemTags.PLATES_ENERGIZED_GOLD),
                'R', Ingredient.of(Tags.Items.DUSTS_REDSTONE),
                'A', Ingredient.of(EnerjoltItems.ADVANCED_UPGRADE_MODULE)
        ), new String[] {
                ...
                "RAR",
                "GRG"
        }, new ItemStack(EnerjoltItems.RANGE_UPGRADE_MODULE_1.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.RANGE_UPGRADE_MODULE_1), Map.of(
                'G', Ingredient.of(CommonItemTags.PLATES_ENERGIZED_GOLD),
                'r', Ingredient.of(Tags.Items.DUSTS_REDSTONE),
                'A', Ingredient.of(EnerjoltItems.ADVANCED_UPGRADE_MODULE),
                'R', Ingredient.of(EnerjoltItems.RANGE_UPGRADE_MODULE_1)
        ), new String[] {
                "GrG",
                "rAr",
                "GRG"
        }, new ItemStack(EnerjoltItems.RANGE_UPGRADE_MODULE_2.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.RANGE_UPGRADE_MODULE_2), Map.of(
                'G', Ingredient.of(CommonItemTags.PLATES_ENERGIZED_GOLD),
                'r', Ingredient.of(Tags.Items.DUSTS_REDSTONE),
                'A', Ingredient.of(EnerjoltItems.ADVANCED_UPGRADE_MODULE),
                'R', Ingredient.of(EnerjoltItems.RANGE_UPGRADE_MODULE_2)
        ), new String[] {
                "GrG",
                "rAr",
                "GRG"
        }, new ItemStack(EnerjoltItems.RANGE_UPGRADE_MODULE_3.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.BASIC_UPGRADE_MODULE), Map.of(
                'I', Ingredient.of(CommonItemTags.PLATES_IRON),
                'R', Ingredient.of(Tags.Items.DUSTS_REDSTONE),
                'B', Ingredient.of(EnerjoltItems.BASIC_UPGRADE_MODULE),
                'F', Ingredient.of(EnerjoltBlocks.IRON_FLUID_PIPE_ITEM)
        ), new String[] {
                "IFI",
                "RBR",
                "IFI"
        }, new ItemStack(EnerjoltItems.EXTRACTION_DEPTH_UPGRADE_MODULE_1.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.EXTRACTION_DEPTH_UPGRADE_MODULE_1), Map.of(
                'I', Ingredient.of(CommonItemTags.PLATES_IRON),
                'R', Ingredient.of(Tags.Items.DUSTS_REDSTONE),
                'B', Ingredient.of(EnerjoltItems.BASIC_UPGRADE_MODULE),
                'F', Ingredient.of(EnerjoltBlocks.IRON_FLUID_PIPE_ITEM),
                'E', Ingredient.of(EnerjoltItems.EXTRACTION_DEPTH_UPGRADE_MODULE_1)
        ), new String[] {
                "IFI",
                "RBR",
                "IEI"
        }, new ItemStack(EnerjoltItems.EXTRACTION_DEPTH_UPGRADE_MODULE_2.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.EXTRACTION_DEPTH_UPGRADE_MODULE_2), Map.of(
                'I', Ingredient.of(CommonItemTags.PLATES_IRON),
                'R', Ingredient.of(Tags.Items.DUSTS_REDSTONE),
                'A', Ingredient.of(EnerjoltItems.ADVANCED_UPGRADE_MODULE),
                'F', Ingredient.of(EnerjoltBlocks.IRON_FLUID_PIPE_ITEM),
                'E', Ingredient.of(EnerjoltItems.EXTRACTION_DEPTH_UPGRADE_MODULE_2)
        ), new String[] {
                "IFI",
                "RAR",
                "IEI"
        }, new ItemStack(EnerjoltItems.EXTRACTION_DEPTH_UPGRADE_MODULE_3.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.EXTRACTION_DEPTH_UPGRADE_MODULE_3), Map.of(
                'I', Ingredient.of(CommonItemTags.PLATES_IRON),
                'R', Ingredient.of(Tags.Items.DUSTS_REDSTONE),
                'A', Ingredient.of(EnerjoltItems.ADVANCED_UPGRADE_MODULE),
                'F', Ingredient.of(EnerjoltBlocks.IRON_FLUID_PIPE_ITEM),
                'E', Ingredient.of(EnerjoltItems.EXTRACTION_DEPTH_UPGRADE_MODULE_3)
        ), new String[] {
                "IFI",
                "RAR",
                "IEI"
        }, new ItemStack(EnerjoltItems.EXTRACTION_DEPTH_UPGRADE_MODULE_4.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.EXTRACTION_DEPTH_UPGRADE_MODULE_4), Map.of(
                'I', Ingredient.of(CommonItemTags.PLATES_IRON),
                'r', Ingredient.of(Tags.Items.DUSTS_REDSTONE),
                'R', Ingredient.of(EnerjoltItems.REINFORCED_ADVANCED_UPGRADE_MODULE),
                'F', Ingredient.of(EnerjoltBlocks.IRON_FLUID_PIPE_ITEM),
                'E', Ingredient.of(EnerjoltItems.EXTRACTION_DEPTH_UPGRADE_MODULE_4)
        ), new String[] {
                "IFI",
                "rRr",
                "IEI"
        }, new ItemStack(EnerjoltItems.EXTRACTION_DEPTH_UPGRADE_MODULE_5.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltItems.BASIC_UPGRADE_MODULE), Map.of(
                ...
                "FBF",
                "IRI"
        }, new ItemStack(EnerjoltItems.EXTRACTION_RANGE_UPGRADE_MODULE_1.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.EXTRACTION_RANGE_UPGRADE_MODULE_1), Map.of(
                'I', Ingredient.of(CommonItemTags.PLATES_IRON),
                'R', Ingredient.of(Tags.Items.DUSTS_REDSTONE),
                'B', Ingredient.of(EnerjoltItems.BASIC_UPGRADE_MODULE),
                'F', Ingredient.of(EnerjoltBlocks.IRON_FLUID_PIPE_ITEM),
                'E', Ingredient.of(EnerjoltItems.EXTRACTION_RANGE_UPGRADE_MODULE_1)
        ), new String[] {
                "IRI",
                "FBF",
                "IEI"
        }, new ItemStack(EnerjoltItems.EXTRACTION_RANGE_UPGRADE_MODULE_2.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.EXTRACTION_RANGE_UPGRADE_MODULE_2), Map.of(
                'I', Ingredient.of(CommonItemTags.PLATES_IRON),
                'R', Ingredient.of(Tags.Items.DUSTS_REDSTONE),
                'A', Ingredient.of(EnerjoltItems.ADVANCED_UPGRADE_MODULE),
                'F', Ingredient.of(EnerjoltBlocks.IRON_FLUID_PIPE_ITEM),
                'E', Ingredient.of(EnerjoltItems.EXTRACTION_RANGE_UPGRADE_MODULE_2)
        ), new String[] {
                "IRI",
                "FAF",
                "IEI"
        }, new ItemStack(EnerjoltItems.EXTRACTION_RANGE_UPGRADE_MODULE_3.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.EXTRACTION_RANGE_UPGRADE_MODULE_3), Map.of(
                'I', Ingredient.of(CommonItemTags.PLATES_IRON),
                'R', Ingredient.of(Tags.Items.DUSTS_REDSTONE),
                'A', Ingredient.of(EnerjoltItems.ADVANCED_UPGRADE_MODULE),
                'F', Ingredient.of(EnerjoltBlocks.IRON_FLUID_PIPE_ITEM),
                'E', Ingredient.of(EnerjoltItems.EXTRACTION_RANGE_UPGRADE_MODULE_3)
        ), new String[] {
                "IRI",
                "FAF",
                "IEI"
        }, new ItemStack(EnerjoltItems.EXTRACTION_RANGE_UPGRADE_MODULE_4.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.EXTRACTION_RANGE_UPGRADE_MODULE_4), Map.of(
                'I', Ingredient.of(CommonItemTags.PLATES_IRON),
                'r', Ingredient.of(Tags.Items.DUSTS_REDSTONE),
                'R', Ingredient.of(EnerjoltItems.REINFORCED_ADVANCED_UPGRADE_MODULE),
                'F', Ingredient.of(EnerjoltBlocks.IRON_FLUID_PIPE_ITEM),
                'E', Ingredient.of(EnerjoltItems.EXTRACTION_RANGE_UPGRADE_MODULE_4)
        ), new String[] {
                "IrI",
                "FRF",
                "IEI"
        }, new ItemStack(EnerjoltItems.EXTRACTION_RANGE_UPGRADE_MODULE_5.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltItems.BASIC_UPGRADE_MODULE), Map.of(
                ...
                "RBR",
                "CbC"
        }, new ItemStack(EnerjoltItems.BLAST_FURNACE_UPGRADE_MODULE.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltItems.BASIC_UPGRADE_MODULE), Map.of(
                ...
                "RBR",
                "CSC"
        }, new ItemStack(EnerjoltItems.SMOKER_UPGRADE_MODULE.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.BASIC_UPGRADE_MODULE), Map.of(
                'G', Ingredient.of(CommonItemTags.PLATES_GOLD),
                'S', Ingredient.of(CommonItemTags.SILICON),
                'b', Ingredient.of(EnerjoltItems.BASIC_SOLAR_CELL),
                'B', Ingredient.of(EnerjoltItems.BASIC_UPGRADE_MODULE)
        ), new String[] {
                "GSG",
                "bBb",
                "GSG"
        }, new ItemStack(EnerjoltItems.MOON_LIGHT_UPGRADE_MODULE_1.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.MOON_LIGHT_UPGRADE_MODULE_1), Map.of(
                'G', Ingredient.of(CommonItemTags.PLATES_GOLD),
                'S', Ingredient.of(CommonItemTags.SILICON),
                'B', Ingredient.of(EnerjoltItems.BASIC_SOLAR_CELL),
                'A', Ingredient.of(EnerjoltItems.ADVANCED_UPGRADE_MODULE),
                'M', Ingredient.of(EnerjoltItems.MOON_LIGHT_UPGRADE_MODULE_1)
        ), new String[] {
                "GSG",
                "BAB",
                "GMG"
        }, new ItemStack(EnerjoltItems.MOON_LIGHT_UPGRADE_MODULE_2.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.MOON_LIGHT_UPGRADE_MODULE_2), Map.of(
                'G', Ingredient.of(CommonItemTags.PLATES_GOLD),
                'S', Ingredient.of(CommonItemTags.SILICON),
                'B', Ingredient.of(EnerjoltItems.BASIC_SOLAR_CELL),
                'R', Ingredient.of(EnerjoltItems.REINFORCED_ADVANCED_UPGRADE_MODULE),
                'M', Ingredient.of(EnerjoltItems.MOON_LIGHT_UPGRADE_MODULE_2)
        ), new String[] {
                "GSG",
                "BRB",
                "GMG"
        }, new ItemStack(EnerjoltItems.MOON_LIGHT_UPGRADE_MODULE_3.get()), CraftingBookCategory.MISC);
    }
    private void buildToolsCraftingRecipes(RecipeOutput output) {
        addHammerCraftingRecipe(output, ItemTags.PLANKS, EnerjoltItems.WOODEN_HAMMER);
        addHammerCraftingRecipe(output, ItemTags.STONE_TOOL_MATERIALS, EnerjoltItems.STONE_HAMMER);
        addHammerCraftingRecipe(output, Tags.Items.INGOTS_IRON, EnerjoltItems.IRON_HAMMER);
        addHammerCraftingRecipe(output, Tags.Items.INGOTS_GOLD, EnerjoltItems.GOLDEN_HAMMER);
        addHammerCraftingRecipe(output, Tags.Items.GEMS_DIAMOND, EnerjoltItems.DIAMOND_HAMMER);
        ...
        addShapedCraftingRecipe(output, has(CommonItemTags.PLATES_IRON), Map.of(
                ...
                " i ",
                "S S"
        }, new ItemStack(EnerjoltItems.CUTTER.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(Tags.Items.INGOTS_IRON), Map.of(
                ...
                " iI",
                "i  "
        }, new ItemStack(EnerjoltItems.WRENCH.get()), CraftingBookCategory.MISC);
    }
    private void buildEnergyItemsCraftingRecipes(RecipeOutput output) {
        addShapedCraftingRecipe(output, has(Tags.Items.INGOTS_COPPER), Map.of(
                ...
                "CRC",
                "CcC"
        }, new ItemStack(EnerjoltItems.BATTERY_1.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.BATTERY_1), Map.of(
                'T', Ingredient.of(CommonItemTags.NUGGETS_TIN),
                'I', Ingredient.of(CommonItemTags.PLATES_IRON),
                'C', Ingredient.of(CommonItemTags.PLATES_COPPER),
                'c', Ingredient.of(ItemTags.COALS),
                'B', Ingredient.of(EnerjoltItems.BATTERY_1)
        ), new String[] {
                "T T",
                "CBC",
                "IcI"
        }, new ItemStack(EnerjoltItems.BATTERY_2.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.BATTERY_2), Map.of(
                'T', Ingredient.of(CommonItemTags.NUGGETS_TIN),
                'C', Ingredient.of(CommonItemTags.PLATES_COPPER),
                'S', Ingredient.of(CommonItemTags.SILICON),
                'B', Ingredient.of(EnerjoltItems.BATTERY_2)
        ), new String[] {
                "T T",
                "BCB",
                "CSC"
        }, new ItemStack(EnerjoltItems.BATTERY_3.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.BATTERY_3), Map.of(
                'T', Ingredient.of(CommonItemTags.NUGGETS_TIN),
                'I', Ingredient.of(CommonItemTags.PLATES_IRON),
                'C', Ingredient.of(CommonItemTags.PLATES_COPPER),
                'S', Ingredient.of(CommonItemTags.SILICON),
                'B', Ingredient.of(EnerjoltItems.BATTERY_3)
        ), new String[] {
                "T T",
                "CBC",
                "SIS"
        }, new ItemStack(EnerjoltItems.BATTERY_4.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.BATTERY_4), Map.of(
                'T', Ingredient.of(CommonItemTags.NUGGETS_TIN),
                'I', Ingredient.of(CommonItemTags.PLATES_IRON),
                'R', Ingredient.of(CommonItemTags.INGOTS_REDSTONE_ALLOY),
                'S', Ingredient.of(CommonItemTags.SILICON),
                'B', Ingredient.of(EnerjoltItems.BATTERY_4)
        ), new String[] {
                "T T",
                "BSB",
                "IRI"
        }, new ItemStack(EnerjoltItems.BATTERY_5.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.BATTERY_5), Map.of(
                'T', Ingredient.of(CommonItemTags.NUGGETS_TIN),
                'E', Ingredient.of(CommonItemTags.PLATES_ENERGIZED_COPPER),
                'B', Ingredient.of(EnerjoltItems.BATTERY_5)
        ), new String[] {
                "T T",
                "EBE",
                "EBE"
        }, new ItemStack(EnerjoltItems.BATTERY_6.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.BATTERY_6), Map.of(
                'G', Ingredient.of(Tags.Items.NUGGETS_GOLD),
                'E', Ingredient.of(CommonItemTags.PLATES_ENERGIZED_GOLD),
                'S', Ingredient.of(CommonItemTags.SILICON),
                'B', Ingredient.of(EnerjoltItems.BATTERY_6)
        ), new String[] {
                "G G",
                "EBE",
                "SBS"
        }, new ItemStack(EnerjoltItems.BATTERY_7.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.BATTERY_7), Map.of(
                'G', Ingredient.of(Tags.Items.NUGGETS_GOLD),
                'E', Ingredient.of(CommonItemTags.PLATES_ENERGIZED_GOLD),
                'A', Ingredient.of(CommonItemTags.PLATES_ADVANCED_ALLOY),
                'B', Ingredient.of(EnerjoltItems.BATTERY_7)
        ), new String[] {
                "G G",
                "EBE",
                "ABA"
        }, new ItemStack(EnerjoltItems.BATTERY_8.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.COAL_ENGINE_ITEM), Map.of(
                'S', Ingredient.of(CommonItemTags.SILICON),
                'I', Ingredient.of(CommonItemTags.PLATES_IRON),
                'R', Ingredient.of(Tags.Items.DUSTS_REDSTONE),
                'c', Ingredient.of(CommonItemTags.PLATES_COPPER),
                'C', Ingredient.of(EnerjoltBlocks.COAL_ENGINE_ITEM)
        ), new String[] {
                "SIS",
                "RCR",
                "cIc"
        }, new ItemStack(EnerjoltItems.INVENTORY_COAL_ENGINE.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.CHARGER_ITEM), Map.of(
                'c', Ingredient.of(CommonItemTags.PLATES_COPPER),
                'I', Ingredient.of(CommonItemTags.PLATES_IRON),
                'R', Ingredient.of(Tags.Items.DUSTS_REDSTONE),
                'S', Ingredient.of(CommonItemTags.SILICON),
                'C', Ingredient.of(EnerjoltBlocks.CHARGER_ITEM)
        ), new String[] {
                "SIS",
                "RCR",
                "cIc"
        }, new ItemStack(EnerjoltItems.INVENTORY_CHARGER.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.TELEPORTER_ITEM), Map.of(
                'C', Ingredient.of(EnerjoltItems.ENERGIZED_CRYSTAL_MATRIX),
                'c', Ingredient.of(CommonItemTags.PLATES_ENERGIZED_COPPER),
                'G', Ingredient.of(CommonItemTags.PLATES_ENERGIZED_GOLD),
                'R', Ingredient.of(Tags.Items.DUSTS_REDSTONE),
                'T', Ingredient.of(EnerjoltBlocks.TELEPORTER_ITEM)
        ), new String[] {
                "CcC",
                "RTR",
                "GcG"
        }, new ItemStack(EnerjoltItems.INVENTORY_TELEPORTER.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltItems.BATTERY_3), Map.of(
                ...
                "bRb",
                "CBC"
        }, new ItemStack(EnerjoltItems.ENERGY_ANALYZER.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltItems.BATTERY_3), Map.of(
                ...
                "bLb",
                "CBC"
        }, new ItemStack(EnerjoltItems.FLUID_ANALYZER.get()), CraftingBookCategory.MISC);
    }
    private void buildItemTransportCraftingRecipes(RecipeOutput output) {
        addShapedCraftingRecipe(output, has(CommonItemTags.PLATES_IRON), Map.of(
                        ...
                        "LLL",
                        "IRI"
                }, new ItemStack(EnerjoltBlocks.BASIC_ITEM_CONVEYOR_BELT_ITEM.get(), 6), CraftingBookCategory.MISC,
        ...
        addShapedCraftingRecipe(output, has(CommonItemTags.INGOTS_STEEL), Map.of(
                ...
                'I', Ingredient.of(CommonItemTags.PLATES_IRON),
                'R', Ingredient.of(Tags.Items.DUSTS_REDSTONE),
                'B', Ingredient.of(EnerjoltBlocks.BASIC_ITEM_CONVEYOR_BELT_ITEM)
        ), new String[] {
                "RIR",
                "SBS",
                "RIR"
        }, new ItemStack(EnerjoltBlocks.FAST_ITEM_CONVEYOR_BELT_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(CommonItemTags.GEARS_IRON), Map.of(
                'G', Ingredient.of(CommonItemTags.GEARS_IRON),
                'R', Ingredient.of(CommonItemTags.RODS_IRON),
                'r', Ingredient.of(Tags.Items.DUSTS_REDSTONE),
                'F', Ingredient.of(EnerjoltBlocks.FAST_ITEM_CONVEYOR_BELT_ITEM)
        ), new String[] {
                "GRG",
                "rFr",
                "GRG"
        }, new ItemStack(EnerjoltBlocks.EXPRESS_ITEM_CONVEYOR_BELT_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.BASIC_ITEM_CONVEYOR_BELT_ITEM), Map.of(
                'C', Ingredient.of(Tags.Items.COBBLESTONES_NORMAL),
                'c', Ingredient.of(EnerjoltBlocks.BASIC_ITEM_CONVEYOR_BELT_ITEM),
                'H', Ingredient.of(Items.HOPPER)
        ), new String[] {
                "CCC",
                "CHC",
                "CcC"
        }, new ItemStack(EnerjoltBlocks.BASIC_ITEM_CONVEYOR_BELT_LOADER_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.FAST_ITEM_CONVEYOR_BELT_ITEM), Map.of(
                'b', Ingredient.of(Items.BRICKS),
                'S', Ingredient.of(Items.SMOOTH_STONE),
                'F', Ingredient.of(EnerjoltBlocks.FAST_ITEM_CONVEYOR_BELT_ITEM),
                'B', Ingredient.of(EnerjoltBlocks.BASIC_ITEM_CONVEYOR_BELT_LOADER)
        ), new String[] {
                "bbb",
                "bBb",
                "SFS"
        }, new ItemStack(EnerjoltBlocks.FAST_ITEM_CONVEYOR_BELT_LOADER_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.EXPRESS_ITEM_CONVEYOR_BELT_ITEM), Map.of(
                'I', Ingredient.of(Tags.Items.STORAGE_BLOCKS_IRON),
                'i', Ingredient.of(CommonItemTags.GEARS_IRON),
                's', Ingredient.of(CommonItemTags.INGOTS_STEEL),
                'S', Ingredient.of(Items.SMOOTH_STONE),
                'E', Ingredient.of(EnerjoltBlocks.EXPRESS_ITEM_CONVEYOR_BELT_ITEM),
                'F', Ingredient.of(EnerjoltBlocks.FAST_ITEM_CONVEYOR_BELT_LOADER_ITEM)
        ), new String[] {
                "IiI",
                "sFs",
                "SES"
        }, new ItemStack(EnerjoltBlocks.EXPRESS_ITEM_CONVEYOR_BELT_LOADER_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.BASIC_ITEM_CONVEYOR_BELT_LOADER_ITEM), Map.of(
                'C', Ingredient.of(Tags.Items.COBBLESTONES_NORMAL),
                'I', Ingredient.of(Tags.Items.STORAGE_BLOCKS_IRON),
                'R', Ingredient.of(Tags.Items.STORAGE_BLOCKS_REDSTONE),
                'L', Ingredient.of(EnerjoltBlocks.BASIC_ITEM_CONVEYOR_BELT_LOADER_ITEM)
        ), new String[] {
                "CRC",
                "ILI",
                "CRC"
        }, new ItemStack(EnerjoltBlocks.BASIC_ITEM_CONVEYOR_BELT_SORTER_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.FAST_ITEM_CONVEYOR_BELT_ITEM), Map.of(
                'b', Ingredient.of(Items.BRICKS),
                'S', Ingredient.of(Items.SMOOTH_STONE),
                'F', Ingredient.of(EnerjoltBlocks.FAST_ITEM_CONVEYOR_BELT_ITEM),
                'B', Ingredient.of(EnerjoltBlocks.BASIC_ITEM_CONVEYOR_BELT_SORTER_ITEM)
        ), new String[] {
                "bbb",
                "bBb",
                "SFS"
        }, new ItemStack(EnerjoltBlocks.FAST_ITEM_CONVEYOR_BELT_SORTER_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.EXPRESS_ITEM_CONVEYOR_BELT_ITEM), Map.of(
                ...
                'S', Ingredient.of(Items.SMOOTH_STONE),
                'E', Ingredient.of(EnerjoltBlocks.EXPRESS_ITEM_CONVEYOR_BELT_ITEM),
                'F', Ingredient.of(EnerjoltBlocks.FAST_ITEM_CONVEYOR_BELT_SORTER_ITEM)
        ), new String[] {
                "IiI",
                "sFs",
                "SES"
        }, new ItemStack(EnerjoltBlocks.EXPRESS_ITEM_CONVEYOR_BELT_SORTER_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.BASIC_ITEM_CONVEYOR_BELT_LOADER_ITEM), Map.of(
                ...
                "ILI",
                "CRC"
        }, new ItemStack(EnerjoltBlocks.BASIC_ITEM_CONVEYOR_BELT_SWITCH_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.FAST_ITEM_CONVEYOR_BELT_ITEM), Map.of(
                'b', Ingredient.of(Items.BRICKS),
                'S', Ingredient.of(Items.SMOOTH_STONE),
                'F', Ingredient.of(EnerjoltBlocks.FAST_ITEM_CONVEYOR_BELT_ITEM),
                'B', Ingredient.of(EnerjoltBlocks.BASIC_ITEM_CONVEYOR_BELT_SWITCH_ITEM)
        ), new String[] {
                "bbb",
                "bBb",
                "SFS"
        }, new ItemStack(EnerjoltBlocks.FAST_ITEM_CONVEYOR_BELT_SWITCH_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.EXPRESS_ITEM_CONVEYOR_BELT_ITEM), Map.of(
                ...
                'S', Ingredient.of(Items.SMOOTH_STONE),
                'E', Ingredient.of(EnerjoltBlocks.EXPRESS_ITEM_CONVEYOR_BELT_ITEM),
                'F', Ingredient.of(EnerjoltBlocks.FAST_ITEM_CONVEYOR_BELT_SWITCH_ITEM)
        ), new String[] {
                "IiI",
                "sFs",
                "SES"
        }, new ItemStack(EnerjoltBlocks.EXPRESS_ITEM_CONVEYOR_BELT_SWITCH_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.BASIC_ITEM_CONVEYOR_BELT_LOADER_ITEM), Map.of(
                ...
                "ILI",
                "CRC"
        }, new ItemStack(EnerjoltBlocks.BASIC_ITEM_CONVEYOR_BELT_SPLITTER_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.FAST_ITEM_CONVEYOR_BELT_ITEM), Map.of(
                'b', Ingredient.of(Items.BRICKS),
                'S', Ingredient.of(Items.SMOOTH_STONE),
                'F', Ingredient.of(EnerjoltBlocks.FAST_ITEM_CONVEYOR_BELT_ITEM),
                'B', Ingredient.of(EnerjoltBlocks.BASIC_ITEM_CONVEYOR_BELT_SPLITTER_ITEM)
        ), new String[] {
                "bbb",
                "bBb",
                "SFS"
        }, new ItemStack(EnerjoltBlocks.FAST_ITEM_CONVEYOR_BELT_SPLITTER_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.EXPRESS_ITEM_CONVEYOR_BELT_ITEM), Map.of(
                ...
                'S', Ingredient.of(Items.SMOOTH_STONE),
                'E', Ingredient.of(EnerjoltBlocks.EXPRESS_ITEM_CONVEYOR_BELT_ITEM),
                'F', Ingredient.of(EnerjoltBlocks.FAST_ITEM_CONVEYOR_BELT_SPLITTER_ITEM)
        ), new String[] {
                "IiI",
                "sFs",
                "SES"
        }, new ItemStack(EnerjoltBlocks.EXPRESS_ITEM_CONVEYOR_BELT_SPLITTER_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.BASIC_ITEM_CONVEYOR_BELT_LOADER_ITEM), Map.of(
                ...
                "ILI",
                "CIC"
        }, new ItemStack(EnerjoltBlocks.BASIC_ITEM_CONVEYOR_BELT_MERGER_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.FAST_ITEM_CONVEYOR_BELT_ITEM), Map.of(
                'b', Ingredient.of(Items.BRICKS),
                'S', Ingredient.of(Items.SMOOTH_STONE),
                'F', Ingredient.of(EnerjoltBlocks.FAST_ITEM_CONVEYOR_BELT_ITEM),
                'B', Ingredient.of(EnerjoltBlocks.BASIC_ITEM_CONVEYOR_BELT_MERGER_ITEM)
        ), new String[] {
                "bbb",
                "bBb",
                "SFS"
        }, new ItemStack(EnerjoltBlocks.FAST_ITEM_CONVEYOR_BELT_MERGER_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.EXPRESS_ITEM_CONVEYOR_BELT_ITEM), Map.of(
                ...
                'S', Ingredient.of(Items.SMOOTH_STONE),
                'E', Ingredient.of(EnerjoltBlocks.EXPRESS_ITEM_CONVEYOR_BELT_ITEM),
                'F', Ingredient.of(EnerjoltBlocks.FAST_ITEM_CONVEYOR_BELT_MERGER_ITEM)
        ), new String[] {
                "IiI",
                "sFs",
                "SES"
        }, new ItemStack(EnerjoltBlocks.EXPRESS_ITEM_CONVEYOR_BELT_MERGER_ITEM.get()), CraftingBookCategory.MISC);
        addShapedCraftingRecipe(output, has(CommonItemTags.PLATES_IRON), Map.of(
                ...
                "IBI",
                "III"
        }, new ItemStack(EnerjoltBlocks.ITEM_SILO_TINY_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.ITEM_SILO_TINY_ITEM), Map.of(
                'S', Ingredient.of(EnerjoltBlocks.ITEM_SILO_TINY_ITEM),
                'I', Ingredient.of(Tags.Items.STORAGE_BLOCKS_IRON),
                'i', Ingredient.of(CommonItemTags.PLATES_IRON)
        ), new String[] {
                "IiI",
                "iSi",
                "IiI"
        }, new ItemStack(EnerjoltBlocks.ITEM_SILO_SMALL_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.ITEM_SILO_SMALL_ITEM), Map.of(
                'S', Ingredient.of(EnerjoltBlocks.ITEM_SILO_SMALL_ITEM),
                'I', Ingredient.of(Tags.Items.STORAGE_BLOCKS_IRON),
                'i', Ingredient.of(CommonItemTags.PLATES_IRON),
                's', Ingredient.of(CommonItemTags.INGOTS_STEEL)
        ), new String[] {
                ...
                "iSi",
                "IsI"
        }, new ItemStack(EnerjoltBlocks.ITEM_SILO_MEDIUM_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.ITEM_SILO_MEDIUM_ITEM), Map.of(
                'S', Ingredient.of(EnerjoltBlocks.ITEM_SILO_MEDIUM_ITEM),
                'I', Ingredient.of(Tags.Items.STORAGE_BLOCKS_IRON),
                's', Ingredient.of(CommonItemTags.INGOTS_STEEL)
        ), new String[] {
                "IsI",
                "sSs",
                "IsI"
        }, new ItemStack(EnerjoltBlocks.ITEM_SILO_LARGE_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.ITEM_SILO_LARGE_ITEM), Map.of(
                'S', Ingredient.of(EnerjoltBlocks.ITEM_SILO_LARGE_ITEM),
                'I', Ingredient.of(Tags.Items.STORAGE_BLOCKS_IRON)
        ), new String[] {
                "III",
                "ISI",
                "III"
        }, new ItemStack(EnerjoltBlocks.ITEM_SILO_GIANT_ITEM.get()), CraftingBookCategory.MISC);
    }
    private void buildFluidTransportCraftingRecipes(RecipeOutput output) {
        addShapedCraftingRecipe(output, has(CommonItemTags.PLATES_IRON), Map.of(
                ...
                "IiI",
                "IiI"
        }, new ItemStack(EnerjoltBlocks.IRON_FLUID_PIPE_ITEM.get(), 12), CraftingBookCategory.MISC,
                "", "", "iron_");
        ...
        addShapedCraftingRecipe(output, has(CommonItemTags.PLATES_GOLD), Map.of(
                ...
                "GgG",
                "GgG"
        }, new ItemStack(EnerjoltBlocks.GOLDEN_FLUID_PIPE_ITEM.get(), 12), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(CommonItemTags.PLATES_IRON), Map.of(
                ...
                "IGI",
                "IGI"
        }, new ItemStack(EnerjoltBlocks.FLUID_TANK_SMALL_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.FLUID_TANK_SMALL_ITEM), Map.of(
                'F', Ingredient.of(EnerjoltBlocks.FLUID_TANK_SMALL_ITEM.get()),
                'S', Ingredient.of(CommonItemTags.INGOTS_STEEL)
        ), new String[] {
                "SFS",
                "SFS",
                "SFS"
        }, new ItemStack(EnerjoltBlocks.FLUID_TANK_MEDIUM_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.FLUID_TANK_MEDIUM_ITEM), Map.of(
                'F', Ingredient.of(EnerjoltBlocks.FLUID_TANK_MEDIUM_ITEM.get()),
                'I', Ingredient.of(Tags.Items.STORAGE_BLOCKS_IRON)
        ), new String[] {
                "IFI",
                "IFI",
                "IFI"
        }, new ItemStack(EnerjoltBlocks.FLUID_TANK_LARGE_ITEM.get()), CraftingBookCategory.MISC);
    }
    private void buildEnergyTransportCraftingRecipes(RecipeOutput output) {
        addBasicCableCraftingRecipes(output, CommonItemTags.INGOTS_TIN, CommonItemTags.WIRES_TIN,
                new ItemStack(EnerjoltBlocks.TIN_CABLE_ITEM.get(), 9));
        ...
        addBasicCableCraftingRecipes(output, Tags.Items.INGOTS_GOLD, CommonItemTags.WIRES_GOLD,
                new ItemStack(EnerjoltBlocks.GOLD_CABLE_ITEM.get(), 6));

        addBasicCableCraftingRecipes(output, CommonItemTags.INGOTS_ENERGIZED_COPPER, CommonItemTags.WIRES_ENERGIZED_COPPER,
                new ItemStack(EnerjoltBlocks.ENERGIZED_COPPER_CABLE_ITEM.get(), 3));
        addBasicCableCraftingRecipes(output, CommonItemTags.INGOTS_ENERGIZED_GOLD, CommonItemTags.WIRES_ENERGIZED_GOLD,
                new ItemStack(EnerjoltBlocks.ENERGIZED_GOLD_CABLE_ITEM.get(), 3));

        addShapedCraftingRecipe(output, has(EnerjoltItems.ENERGIZED_CRYSTAL_MATRIX), Map.of(
                'I', Ingredient.of(EnerjoltItems.CABLE_INSULATOR),
                'C', Ingredient.of(EnerjoltItems.ENERGIZED_CRYSTAL_MATRIX)
        ), new String[] {
                "ICI",
                "ICI",
                "ICI"
        }, new ItemStack(EnerjoltBlocks.ENERGIZED_CRYSTAL_MATRIX_CABLE_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.BASIC_MACHINE_FRAME_ITEM), Map.of(
                'S', Ingredient.of(CommonItemTags.SILICON),
                'C', Ingredient.of(CommonItemTags.PLATES_COPPER),
                'I', Ingredient.of(CommonItemTags.PLATES_IRON),
                'R', Ingredient.of(Tags.Items.DUSTS_REDSTONE),
                'M', Ingredient.of(EnerjoltBlocks.BASIC_MACHINE_FRAME_ITEM)
        ), new String[] {
                "CSI",
                "RMR",
                "CSI"
        }, new ItemStack(EnerjoltBlocks.LV_TRANSFORMER_1_TO_N_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.BASIC_MACHINE_FRAME_ITEM), Map.of(
                ...
                "SMR",
                "CRI"
        }, new ItemStack(EnerjoltBlocks.LV_TRANSFORMER_3_TO_3_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.BASIC_MACHINE_FRAME_ITEM), Map.of(
                ...
                "SMS",
                "CRI"
        }, new ItemStack(EnerjoltBlocks.LV_TRANSFORMER_N_TO_1_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.HARDENED_MACHINE_FRAME_ITEM), Map.of(
                'S', Ingredient.of(CommonItemTags.STORAGE_BLOCKS_SILICON),
                'C', Ingredient.of(Tags.Items.STORAGE_BLOCKS_COPPER),
                'I', Ingredient.of(Tags.Items.STORAGE_BLOCKS_IRON),
                'M', Ingredient.of(EnerjoltBlocks.HARDENED_MACHINE_FRAME_ITEM),
                'T', Ingredient.of(EnerjoltBlocks.LV_TRANSFORMER_1_TO_N_ITEM)
        ), new String[] {
                "CTI",
                "SMS",
                "CTI"
        }, new ItemStack(EnerjoltBlocks.MV_TRANSFORMER_1_TO_N_ITEM.get()), CraftingBookCategory.MISC,
                "", "", "mv_");
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.HARDENED_MACHINE_FRAME_ITEM), Map.of(
                ...
                'I', Ingredient.of(Tags.Items.STORAGE_BLOCKS_IRON),
                'M', Ingredient.of(EnerjoltBlocks.HARDENED_MACHINE_FRAME_ITEM),
                'T', Ingredient.of(EnerjoltBlocks.LV_TRANSFORMER_3_TO_3_ITEM)
        ), new String[] {
                "CTI",
                "SMS",
                "CTI"
        }, new ItemStack(EnerjoltBlocks.MV_TRANSFORMER_3_TO_3_ITEM.get()), CraftingBookCategory.MISC,
                "", "", "mv_");
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.HARDENED_MACHINE_FRAME_ITEM), Map.of(
                ...
                'I', Ingredient.of(Tags.Items.STORAGE_BLOCKS_IRON),
                'M', Ingredient.of(EnerjoltBlocks.HARDENED_MACHINE_FRAME_ITEM),
                'T', Ingredient.of(EnerjoltBlocks.LV_TRANSFORMER_N_TO_1_ITEM)
        ), new String[] {
                "CTI",
                "SMS",
                "CTI"
        }, new ItemStack(EnerjoltBlocks.MV_TRANSFORMER_N_TO_1_ITEM.get()), CraftingBookCategory.MISC,
                "", "", "mv_");

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.ADVANCED_MACHINE_FRAME_ITEM), Map.of(
                'S', Ingredient.of(CommonItemTags.STORAGE_BLOCKS_SILICON),
                'G', Ingredient.of(CommonItemTags.PLATES_ENERGIZED_GOLD),
                'M', Ingredient.of(EnerjoltBlocks.ADVANCED_MACHINE_FRAME_ITEM),
                'T', Ingredient.of(EnerjoltBlocks.MV_TRANSFORMER_1_TO_N_ITEM)
        ), new String[] {
                "GTG",
                "SMS",
                "GTG"
        }, new ItemStack(EnerjoltBlocks.HV_TRANSFORMER_1_TO_N_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.ADVANCED_MACHINE_FRAME_ITEM), Map.of(
                'S', Ingredient.of(CommonItemTags.STORAGE_BLOCKS_SILICON),
                'G', Ingredient.of(CommonItemTags.PLATES_ENERGIZED_GOLD),
                'M', Ingredient.of(EnerjoltBlocks.ADVANCED_MACHINE_FRAME_ITEM),
                'T', Ingredient.of(EnerjoltBlocks.MV_TRANSFORMER_3_TO_3_ITEM)
        ), new String[] {
                "GTG",
                "SMS",
                "GTG"
        }, new ItemStack(EnerjoltBlocks.HV_TRANSFORMER_3_TO_3_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.ADVANCED_MACHINE_FRAME_ITEM), Map.of(
                'S', Ingredient.of(CommonItemTags.STORAGE_BLOCKS_SILICON),
                'G', Ingredient.of(CommonItemTags.PLATES_ENERGIZED_GOLD),
                'M', Ingredient.of(EnerjoltBlocks.ADVANCED_MACHINE_FRAME_ITEM),
                'T', Ingredient.of(EnerjoltBlocks.MV_TRANSFORMER_N_TO_1_ITEM)
        ), new String[] {
                "GTG",
                "SMS",
                "GTG"
        }, new ItemStack(EnerjoltBlocks.HV_TRANSFORMER_N_TO_1_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.REINFORCED_ADVANCED_MACHINE_FRAME_ITEM), Map.of(
                'S', Ingredient.of(CommonItemTags.STORAGE_BLOCKS_SILICON),
                'C', Ingredient.of(EnerjoltItems.ENERGIZED_CRYSTAL_MATRIX),
                'M', Ingredient.of(EnerjoltBlocks.REINFORCED_ADVANCED_MACHINE_FRAME_ITEM),
                'T', Ingredient.of(EnerjoltBlocks.HV_TRANSFORMER_1_TO_N_ITEM)
        ), new String[] {
                "CTC",
                "SMS",
                "CTC"
        }, new ItemStack(EnerjoltBlocks.EHV_TRANSFORMER_1_TO_N_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.REINFORCED_ADVANCED_MACHINE_FRAME_ITEM), Map.of(
                'S', Ingredient.of(CommonItemTags.STORAGE_BLOCKS_SILICON),
                'C', Ingredient.of(EnerjoltItems.ENERGIZED_CRYSTAL_MATRIX),
                'M', Ingredient.of(EnerjoltBlocks.REINFORCED_ADVANCED_MACHINE_FRAME_ITEM),
                'T', Ingredient.of(EnerjoltBlocks.HV_TRANSFORMER_3_TO_3_ITEM)
        ), new String[] {
                "CTC",
                "SMS",
                "CTC"
        }, new ItemStack(EnerjoltBlocks.EHV_TRANSFORMER_3_TO_3_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.REINFORCED_ADVANCED_MACHINE_FRAME_ITEM), Map.of(
                'S', Ingredient.of(CommonItemTags.STORAGE_BLOCKS_SILICON),
                'C', Ingredient.of(EnerjoltItems.ENERGIZED_CRYSTAL_MATRIX),
                'M', Ingredient.of(EnerjoltBlocks.REINFORCED_ADVANCED_MACHINE_FRAME_ITEM),
                'T', Ingredient.of(EnerjoltBlocks.HV_TRANSFORMER_N_TO_1_ITEM)
        ), new String[] {
                "CTC",
                "SMS",
                "CTC"
        }, new ItemStack(EnerjoltBlocks.EHV_TRANSFORMER_N_TO_1_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.BASIC_MACHINE_FRAME_ITEM), Map.of(
                ...
                "BMB",
                "CSI"
        }, new ItemStack(EnerjoltBlocks.CONFIGURABLE_LV_TRANSFORMER_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.HARDENED_MACHINE_FRAME_ITEM), Map.of(
                ...
                'I', Ingredient.of(Tags.Items.STORAGE_BLOCKS_IRON),
                'M', Ingredient.of(EnerjoltBlocks.HARDENED_MACHINE_FRAME_ITEM),
                'T', Ingredient.of(EnerjoltBlocks.CONFIGURABLE_LV_TRANSFORMER_ITEM)
        ), new String[] {
                "CTI",
                "BMB",
                "CTI"
        }, new ItemStack(EnerjoltBlocks.CONFIGURABLE_MV_TRANSFORMER_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.ADVANCED_MACHINE_FRAME_ITEM), Map.of(
                'A', Ingredient.of(EnerjoltItems.ADVANCED_CIRCUIT),
                'G', Ingredient.of(CommonItemTags.PLATES_ENERGIZED_GOLD),
                'M', Ingredient.of(EnerjoltBlocks.ADVANCED_MACHINE_FRAME_ITEM),
                'T', Ingredient.of(EnerjoltBlocks.CONFIGURABLE_MV_TRANSFORMER_ITEM)
        ), new String[] {
                "GTG",
                "AMA",
                "GTG"
        }, new ItemStack(EnerjoltBlocks.CONFIGURABLE_HV_TRANSFORMER_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.REINFORCED_ADVANCED_MACHINE_FRAME_ITEM), Map.of(
                'R', Ingredient.of(EnerjoltItems.PROCESSING_UNIT),
                'C', Ingredient.of(EnerjoltItems.ENERGIZED_CRYSTAL_MATRIX),
                'M', Ingredient.of(EnerjoltBlocks.REINFORCED_ADVANCED_MACHINE_FRAME_ITEM),
                'T', Ingredient.of(EnerjoltBlocks.CONFIGURABLE_HV_TRANSFORMER_ITEM)
        ), new String[] {
                "CTC",
                "RMR",
                "CTC"
        }, new ItemStack(EnerjoltBlocks.CONFIGURABLE_EHV_TRANSFORMER_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.BASIC_MACHINE_FRAME_ITEM), Map.of(
                ...
                "BMB",
                "SBS"
        }, new ItemStack(EnerjoltBlocks.BATTERY_BOX_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.ADVANCED_MACHINE_FRAME_ITEM), Map.of(
                'S', Ingredient.of(CommonItemTags.STORAGE_BLOCKS_SILICON),
                'E', Ingredient.of(CommonItemTags.PLATES_ENERGIZED_GOLD),
                'B', Ingredient.of(EnerjoltItems.BATTERY_8),
                'M', Ingredient.of(EnerjoltBlocks.ADVANCED_MACHINE_FRAME_ITEM)
        ), new String[] {
                "EBE",
                "BMB",
                "BSB"
        }, new ItemStack(EnerjoltBlocks.ADVANCED_BATTERY_BOX_ITEM.get()), CraftingBookCategory.MISC);

        addShapelessCraftingRecipe(output, has(EnerjoltBlocks.BATTERY_BOX_ITEM), List.of(
                Ingredient.of(EnerjoltBlocks.BATTERY_BOX_ITEM),
                Ingredient.of(Items.MINECART)
        ), new ItemStack(EnerjoltItems.BATTERY_BOX_MINECART.get()), CraftingBookCategory.MISC);

        addShapelessCraftingRecipe(output, has(EnerjoltBlocks.ADVANCED_BATTERY_BOX_ITEM), List.of(
                Ingredient.of(EnerjoltBlocks.ADVANCED_BATTERY_BOX_ITEM),
                Ingredient.of(Items.MINECART)
        ), new ItemStack(EnerjoltItems.ADVANCED_BATTERY_BOX_MINECART.get()), CraftingBookCategory.MISC);
    }
    private void buildMachineCraftingRecipes(RecipeOutput output) {
        addShapedCraftingRecipe(output, has(Items.SMOOTH_STONE), Map.of(
                ...
                "BsB",
                "SSS"
        }, new ItemStack(EnerjoltBlocks.PRESS_MOLD_MAKER_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(Items.FURNACE), Map.of(
                ...
                "FIF",
                "BBB"
        }, new ItemStack(EnerjoltBlocks.ALLOY_FURNACE_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.BASIC_MACHINE_FRAME_ITEM), Map.of(
                ...
                "bBb",
                "ITI"
        }, new ItemStack(EnerjoltBlocks.AUTO_CRAFTER_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.ADVANCED_MACHINE_FRAME), Map.of(
                'c', Ingredient.of(EnerjoltItems.ADVANCED_CIRCUIT),
                'P', Ingredient.of(CommonItemTags.PLATES_ADVANCED_ALLOY),
                'G', Ingredient.of(CommonItemTags.PLATES_ENERGIZED_GOLD),
                'A', Ingredient.of(EnerjoltBlocks.ADVANCED_MACHINE_FRAME_ITEM),
                'a', Ingredient.of(EnerjoltBlocks.AUTO_CRAFTER_ITEM)
        ), new String[] {
                "GaG",
                "cAc",
                "PaP"
        }, new ItemStack(EnerjoltBlocks.ADVANCED_AUTO_CRAFTER_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.BASIC_MACHINE_FRAME_ITEM), Map.of(
                ...
                "SBS",
                "CIC"
        }, new ItemStack(EnerjoltBlocks.CRUSHER_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.ADVANCED_MACHINE_FRAME_ITEM), Map.of(
                'c', Ingredient.of(CommonItemTags.PLATES_ENERGIZED_COPPER),
                'a', Ingredient.of(CommonItemTags.PLATES_ADVANCED_ALLOY),
                'F', Ingredient.of(EnerjoltBlocks.FLUID_TANK_SMALL_ITEM),
                'A', Ingredient.of(EnerjoltBlocks.ADVANCED_MACHINE_FRAME_ITEM),
                'C', Ingredient.of(EnerjoltBlocks.CRUSHER_ITEM)
        ), new String[] {
                "aCa",
                "FAF",
                "cCc"
        }, new ItemStack(EnerjoltBlocks.ADVANCED_CRUSHER_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.BASIC_MACHINE_FRAME_ITEM), Map.of(
                ...
                "SBS",
                "ISI"
        }, new ItemStack(EnerjoltBlocks.PULVERIZER_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.ADVANCED_MACHINE_FRAME_ITEM), Map.of(
                ...
                'F', Ingredient.of(EnerjoltBlocks.FLUID_TANK_SMALL_ITEM),
                'A', Ingredient.of(EnerjoltBlocks.ADVANCED_MACHINE_FRAME_ITEM),
                'P', Ingredient.of(EnerjoltBlocks.PULVERIZER_ITEM)
        ), new String[] {
                "aPa",
                "FAF",
                "CPC"
        }, new ItemStack(EnerjoltBlocks.ADVANCED_PULVERIZER_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.BASIC_MACHINE_FRAME_ITEM), Map.of(
                'S', Ingredient.of(EnerjoltItems.SAW_BLADE),
                's', Ingredient.of(EnerjoltItems.SILICON),
                'I', Ingredient.of(CommonItemTags.PLATES_IRON),
                'C', Ingredient.of(CommonItemTags.PLATES_COPPER),
                'B', Ingredient.of(EnerjoltBlocks.BASIC_MACHINE_FRAME_ITEM)
        ), new String[] {
                ...
                "CBC",
                "sIs"
        }, new ItemStack(EnerjoltBlocks.SAWMILL_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.BASIC_MACHINE_FRAME_ITEM), Map.of(
                ...
                "PBP",
                "IPI"
        }, new ItemStack(EnerjoltBlocks.COMPRESSOR_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.BASIC_MACHINE_FRAME_ITEM), Map.of(
                ...
                "IBI",
                "SIS"
        }, new ItemStack(EnerjoltBlocks.METAL_PRESS_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.BASIC_MACHINE_FRAME_ITEM), Map.of(
                'I', Ingredient.of(CommonItemTags.GEARS_IRON),
                'i', Ingredient.of(CommonItemTags.RODS_IRON),
                'B', Ingredient.of(EnerjoltBlocks.BASIC_MACHINE_FRAME_ITEM),
                'P', Ingredient.of(EnerjoltBlocks.PRESS_MOLD_MAKER_ITEM)
        ), new String[] {
                "IPI",
                "iBi",
                "IPI"
        }, new ItemStack(EnerjoltBlocks.AUTO_PRESS_MOLD_MAKER_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.BASIC_MACHINE_FRAME_ITEM), Map.of(
                ...
                "sBs",
                "ISI"
        }, new ItemStack(EnerjoltBlocks.AUTO_STONECUTTER_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.BASIC_MACHINE_FRAME_ITEM), Map.of(
                ...
                "GBG",
                "IDI"
        }, new ItemStack(EnerjoltBlocks.PLANT_GROWTH_CHAMBER_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.BASIC_MACHINE_FRAME_ITEM), Map.of(
                ...
                "DBD",
                "SDC"
        }, new ItemStack(EnerjoltBlocks.BLOCK_PLACER_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.HARDENED_MACHINE_FRAME_ITEM), Map.of(
                ...
                "BHB",
                "SsS"
        }, new ItemStack(EnerjoltBlocks.ASSEMBLING_MACHINE_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.HARDENED_MACHINE_FRAME_ITEM), Map.of(
                'B', Ingredient.of(EnerjoltItems.BASIC_CIRCUIT),
                'S', Ingredient.of(CommonItemTags.INGOTS_STEEL),
                'H', Ingredient.of(EnerjoltBlocks.HARDENED_MACHINE_FRAME_ITEM),
                'A', Ingredient.of(EnerjoltBlocks.ALLOY_FURNACE_ITEM)
        ), new String[] {
                "SAS",
                "BHB",
                "SAS"
        }, new ItemStack(EnerjoltBlocks.INDUCTION_SMELTER_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.BASIC_MACHINE_FRAME_ITEM), Map.of(
                ...
                "IBI",
                "CFC"
        }, new ItemStack(EnerjoltBlocks.FLUID_FILLER_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.HARDENED_MACHINE_FRAME_ITEM), Map.of(
                ...
                "IHI",
                "CFC"
        }, new ItemStack(EnerjoltBlocks.STONE_LIQUEFIER_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.HARDENED_MACHINE_FRAME_ITEM), Map.of(
                ...
                "FHF",
                "CIC"
        }, new ItemStack(EnerjoltBlocks.STONE_SOLIDIFIER_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.HARDENED_MACHINE_FRAME_ITEM), Map.of(
                'i', Ingredient.of(CommonItemTags.PLATES_IRON),
                'I', Ingredient.of(Tags.Items.STORAGE_BLOCKS_IRON),
                'C', Ingredient.of(CommonItemTags.PLATES_COPPER),
                'D', Ingredient.of(EnerjoltBlocks.FLUID_DRAINER_ITEM),
                'F', Ingredient.of(EnerjoltBlocks.FLUID_FILLER_ITEM),
                'f', Ingredient.of(EnerjoltBlocks.FLUID_TANK_SMALL_ITEM),
                'H', Ingredient.of(EnerjoltBlocks.HARDENED_MACHINE_FRAME_ITEM)
        ), new String[] {
                "CiC",
                "DHF",
                "IfI"
        }, new ItemStack(EnerjoltBlocks.FLUID_TRANSPOSER_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.HARDENED_MACHINE_FRAME_ITEM), Map.of(
                ...
                "FHF",
                "IfI"
        }, new ItemStack(EnerjoltBlocks.FILTRATION_PLANT_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.BASIC_MACHINE_FRAME_ITEM), Map.of(
                ...
                "IBI",
                "SIS"
        }, new ItemStack(EnerjoltBlocks.FLUID_DRAINER_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.BASIC_MACHINE_FRAME_ITEM), Map.of(
                ...
                'B', Ingredient.of(EnerjoltBlocks.BASIC_MACHINE_FRAME_ITEM),
                'P', Ingredient.of(Items.PISTON),
                'p', Ingredient.of(EnerjoltBlocks.IRON_FLUID_PIPE_ITEM)
        ), new String[] {
                "RPR",
                "FBF",
                "IpI"
        }, new ItemStack(EnerjoltBlocks.FLUID_PUMP_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.ADVANCED_MACHINE_FRAME_ITEM), Map.of(
                'G', Ingredient.of(CommonItemTags.PLATES_ENERGIZED_GOLD),
                'a', Ingredient.of(CommonItemTags.PLATES_ADVANCED_ALLOY),
                'A', Ingredient.of(EnerjoltBlocks.ADVANCED_MACHINE_FRAME_ITEM),
                'F', Ingredient.of(EnerjoltBlocks.FLUID_PUMP_ITEM),
                'f', Ingredient.of(EnerjoltBlocks.FLUID_TANK_LARGE_ITEM)
        ), new String[] {
                "GFG",
                "fAf",
                "aFa"
        }, new ItemStack(EnerjoltBlocks.ADVANCED_FLUID_PUMP_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(Tags.Items.STORAGE_BLOCKS_IRON), Map.of(
                ...
                "iGi",
                "IiI"
        }, new ItemStack(EnerjoltBlocks.DRAIN_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.BASIC_MACHINE_FRAME_ITEM), Map.of(
                ...
                "IBI",
                "CSC"
        }, new ItemStack(EnerjoltBlocks.CHARGER_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.ADVANCED_MACHINE_FRAME_ITEM), Map.of(
                ...
                "aAa",
                "GCG"
        }, new ItemStack(EnerjoltBlocks.ADVANCED_CHARGER_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.BASIC_MACHINE_FRAME_ITEM), Map.of(
                ...
                "IBI",
                "sCs"
        }, new ItemStack(EnerjoltBlocks.UNCHARGER_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.ADVANCED_MACHINE_FRAME_ITEM), Map.of(
                ...
                'G', Ingredient.of(CommonItemTags.PLATES_ENERGIZED_GOLD),
                'A', Ingredient.of(EnerjoltBlocks.ADVANCED_MACHINE_FRAME_ITEM),
                'U', Ingredient.of(EnerjoltBlocks.UNCHARGER_ITEM)
        ), new String[] {
                "GUG",
                "aAa",
                "SGS"
        }, new ItemStack(EnerjoltBlocks.ADVANCED_UNCHARGER_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.CHARGER_ITEM), Map.of(
                ...
                'i', Ingredient.of(CommonItemTags.PLATES_IRON),
                'S', Ingredient.of(CommonItemTags.SILICON),
                'H', Ingredient.of(EnerjoltBlocks.CHARGER_ITEM)
        ), new String[] {
                "cCc",
                "SHS",
                "iIi"
        }, new ItemStack(EnerjoltBlocks.MINECART_CHARGER_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.ADVANCED_CHARGER_ITEM), Map.of(
                'G', Ingredient.of(Tags.Items.STORAGE_BLOCKS_GOLD),
                'g', Ingredient.of(CommonItemTags.PLATES_ENERGIZED_GOLD),
                'C', Ingredient.of(Tags.Items.STORAGE_BLOCKS_COPPER),
                'c', Ingredient.of(CommonItemTags.PLATES_ENERGIZED_COPPER),
                'S', Ingredient.of(CommonItemTags.SILICON),
                'H', Ingredient.of(EnerjoltBlocks.ADVANCED_CHARGER_ITEM)
        ), new String[] {
                "gGg",
                "SHS",
                "cCc"
        }, new ItemStack(EnerjoltBlocks.ADVANCED_MINECART_CHARGER_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.UNCHARGER_ITEM), Map.of(
                'C', Ingredient.of(Tags.Items.STORAGE_BLOCKS_COPPER),
                'c', Ingredient.of(CommonItemTags.PLATES_COPPER),
                'I', Ingredient.of(Tags.Items.STORAGE_BLOCKS_IRON),
                'i', Ingredient.of(CommonItemTags.PLATES_IRON),
                ...
                "SUS",
                "cCc"
        }, new ItemStack(EnerjoltBlocks.MINECART_UNCHARGER_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.ADVANCED_UNCHARGER_ITEM), Map.of(
                'G', Ingredient.of(Tags.Items.STORAGE_BLOCKS_GOLD),
                'g', Ingredient.of(CommonItemTags.PLATES_ENERGIZED_GOLD),
                'C', Ingredient.of(Tags.Items.STORAGE_BLOCKS_COPPER),
                'c', Ingredient.of(CommonItemTags.PLATES_ENERGIZED_COPPER),
                'S', Ingredient.of(CommonItemTags.SILICON),
                'U', Ingredient.of(EnerjoltBlocks.ADVANCED_UNCHARGER_ITEM)
        ), new String[] {
                "cCc",
                "SUS",
                "gGg"
        }, new ItemStack(EnerjoltBlocks.ADVANCED_MINECART_UNCHARGER_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.BASIC_SOLAR_CELL), Map.of(
                'G', Ingredient.of(Tags.Items.GLASS_PANES_COLORLESS),
                'R', Ingredient.of(Tags.Items.DUSTS_REDSTONE),
                'I', Ingredient.of(Tags.Items.INGOTS_IRON),
                'C', Ingredient.of(Tags.Items.INGOTS_COPPER),
                ...
                "BRB",
                "ICI"
        }, new ItemStack(EnerjoltBlocks.SOLAR_PANEL_ITEM_1.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.SOLAR_PANEL_ITEM_1), Map.of(
                'G', Ingredient.of(Tags.Items.GLASS_PANES_COLORLESS),
                'C', Ingredient.of(Tags.Items.INGOTS_COPPER),
                'R', Ingredient.of(Tags.Items.DUSTS_REDSTONE),
                'S', Ingredient.of(EnerjoltBlocks.SOLAR_PANEL_ITEM_1),
                'B', Ingredient.of(EnerjoltItems.BASIC_SOLAR_CELL)
        ), new String[] {
                "GGG",
                "SBS",
                "CRC"
        }, new ItemStack(EnerjoltBlocks.SOLAR_PANEL_ITEM_2.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.SOLAR_PANEL_ITEM_2), Map.of(
                'G', Ingredient.of(Tags.Items.GLASS_PANES_COLORLESS),
                'R', Ingredient.of(CommonItemTags.INGOTS_REDSTONE_ALLOY),
                's', Ingredient.of(CommonItemTags.SILICON),
                'S', Ingredient.of(EnerjoltBlocks.SOLAR_PANEL_ITEM_2),
                'B', Ingredient.of(EnerjoltItems.BASIC_SOLAR_CELL)
        ), new String[] {
                "GGG",
                "SBS",
                "sRs"
        }, new ItemStack(EnerjoltBlocks.SOLAR_PANEL_ITEM_3.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.SOLAR_PANEL_ITEM_3), Map.of(
                'G', Ingredient.of(Tags.Items.GLASS_PANES_COLORLESS),
                's', Ingredient.of(CommonItemTags.SILICON),
                'R', Ingredient.of(CommonItemTags.INGOTS_REDSTONE_ALLOY),
                'S', Ingredient.of(EnerjoltBlocks.SOLAR_PANEL_ITEM_3),
                'A', Ingredient.of(EnerjoltItems.ADVANCED_SOLAR_CELL)
        ), new String[] {
                "GGG",
                "SsS",
                "ARA"
        }, new ItemStack(EnerjoltBlocks.SOLAR_PANEL_ITEM_4.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.SOLAR_PANEL_ITEM_4), Map.of(
                'G', Ingredient.of(Tags.Items.GLASS_PANES_COLORLESS),
                'a', Ingredient.of(Tags.Items.GEMS_AMETHYST),
                'E', Ingredient.of(CommonItemTags.INGOTS_ENERGIZED_GOLD),
                'S', Ingredient.of(EnerjoltBlocks.SOLAR_PANEL_ITEM_4),
                'A', Ingredient.of(EnerjoltItems.ADVANCED_SOLAR_CELL)
        ), new String[] {
                "GGG",
                "SaS",
                "AEA"
        }, new ItemStack(EnerjoltBlocks.SOLAR_PANEL_ITEM_5.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.SOLAR_PANEL_ITEM_5), Map.of(
                'G', Ingredient.of(Tags.Items.GLASS_PANES_COLORLESS),
                'A', Ingredient.of(Tags.Items.GEMS_AMETHYST),
                'E', Ingredient.of(CommonItemTags.INGOTS_ENERGIZED_GOLD),
                'S', Ingredient.of(EnerjoltBlocks.SOLAR_PANEL_ITEM_5),
                'R', Ingredient.of(EnerjoltItems.REINFORCED_ADVANCED_SOLAR_CELL)
        ), new String[] {
                "GGG",
                "SAS",
                "RER"
        }, new ItemStack(EnerjoltBlocks.SOLAR_PANEL_ITEM_6.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.BASIC_MACHINE_FRAME_ITEM), Map.of(
                ...
                "CBC",
                "IFI"
        }, new ItemStack(EnerjoltBlocks.COAL_ENGINE_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(Items.REDSTONE_LAMP), Map.of(
                ...
                "SRS",
                "CSC"
        }, new ItemStack(EnerjoltBlocks.POWERED_LAMP_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.BASIC_MACHINE_FRAME_ITEM), Map.of(
                ...
                "SBS",
                "IFI"
        }, new ItemStack(EnerjoltBlocks.POWERED_FURNACE_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.ADVANCED_MACHINE_FRAME_ITEM), Map.of(
                ...
                'G', Ingredient.of(CommonItemTags.PLATES_ENERGIZED_GOLD),
                'A', Ingredient.of(EnerjoltBlocks.ADVANCED_MACHINE_FRAME_ITEM),
                'P', Ingredient.of(EnerjoltBlocks.POWERED_FURNACE_ITEM)
        ), new String[] {
                "GPG",
                "SAS",
                "aPa"
        }, new ItemStack(EnerjoltBlocks.ADVANCED_POWERED_FURNACE_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.ADVANCED_MACHINE_FRAME_ITEM), Map.of(
                ...
                "GAG",
                "ECE"
        }, new ItemStack(EnerjoltBlocks.LIGHTNING_GENERATOR_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.ADVANCED_MACHINE_FRAME_ITEM), Map.of(
                ...
                "GAG",
                "ESE"
        }, new ItemStack(EnerjoltBlocks.ENERGIZER_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.ADVANCED_MACHINE_FRAME_ITEM), Map.of(
                ...
                "IAI",
                "ECE"
        }, new ItemStack(EnerjoltBlocks.CHARGING_STATION_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.COAL_ENGINE_ITEM), Map.of(
                ...
                "sCs",
                "cSc"
        }, new ItemStack(EnerjoltBlocks.HEAT_GENERATOR_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.HARDENED_MACHINE_FRAME_ITEM), Map.of(
                ...
                'C', Ingredient.of(Tags.Items.STORAGE_BLOCKS_COPPER),
                'H', Ingredient.of(EnerjoltBlocks.HARDENED_MACHINE_FRAME_ITEM),
                'E', Ingredient.of(EnerjoltBlocks.COAL_ENGINE_ITEM)
        ), new String[] {
                "cHc",
                "SES",
                "CFC"
        }, new ItemStack(EnerjoltBlocks.THERMAL_GENERATOR_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.ADVANCED_MACHINE_FRAME_ITEM), Map.of(
                ...
                "EAE",
                "aPa"
        }, new ItemStack(EnerjoltBlocks.CRYSTAL_GROWTH_CHAMBER_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.REINFORCED_ADVANCED_MACHINE_FRAME_ITEM), Map.of(
                ...
                'E', Ingredient.of(CommonItemTags.PLATES_ENERGIZED_GOLD),
                'A', Ingredient.of(Tags.Items.GEMS_AMETHYST),
                'R', Ingredient.of(EnerjoltBlocks.REINFORCED_ADVANCED_MACHINE_FRAME_ITEM)
        ), new String[] {
                "CAC",
                "PRP",
                "aEa"
        }, new ItemStack(EnerjoltBlocks.WEATHER_CONTROLLER_ITEM.get()), CraftingBookCategory.MISC);
        ...
        addShapedCraftingRecipe(output, has(EnerjoltBlocks.REINFORCED_ADVANCED_MACHINE_FRAME_ITEM), Map.of(
                ...
                "PRP",
                "AEA"
        }, new ItemStack(EnerjoltBlocks.TIME_CONTROLLER_ITEM.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltBlocks.REINFORCED_ADVANCED_MACHINE_FRAME_ITEM), Map.of(
                'T', Ingredient.of(EnerjoltItems.TELEPORTER_PROCESSING_UNIT),
                'C', Ingredient.of(EnerjoltItems.ENERGIZED_CRYSTAL_MATRIX),
                'A', Ingredient.of(CommonItemTags.PLATES_ADVANCED_ALLOY),
                'E', Ingredient.of(CommonItemTags.PLATES_ENERGIZED_GOLD),
                'S', Ingredient.of(CommonItemTags.STORAGE_BLOCKS_SILICON),
                ...
                "TRT",
                "ASA"
        }, new ItemStack(EnerjoltBlocks.TELEPORTER_ITEM.get()), CraftingBookCategory.MISC);
    }
    private void buildMiscCraftingRecipes(RecipeOutput output) {
        addShapelessCraftingRecipe(output, InventoryChangeTrigger.TriggerInstance.hasItems(
                Items.BOOK,
                EnerjoltBlocks.BASIC_MACHINE_FRAME_ITEM
        ), List.of(
        ...
        addShapedCraftingRecipe(output, has(CommonItemTags.DUSTS_CHARCOAL), Map.of(
                ...
                "CIC",
                "PCP"
        }, new ItemStack(EnerjoltItems.CHARCOAL_FILTER.get()), CraftingBookCategory.MISC);

        addShapedCraftingRecipe(output, has(EnerjoltItems.ENERGIZED_CRYSTAL_MATRIX), Map.of(
                'A', Ingredient.of(Tags.Items.GEMS_AMETHYST),
                'E', Ingredient.of(EnerjoltItems.ENERGIZED_CRYSTAL_MATRIX),
                'e', Ingredient.of(Tags.Items.ENDER_PEARLS)
        ), new String[] {
                "AEA",
                "EeE",
                "AEA"
        }, new ItemStack(EnerjoltItems.TELEPORTER_MATRIX.get()), CraftingBookCategory.MISC);
    }
    ...
    private void buildCookingRecipes(RecipeOutput output) {
        addBlastingAndSmeltingRecipes(output, CommonItemTags.RAW_MATERIALS_TIN, new ItemStack(EnerjoltItems.TIN_INGOT.get()), CookingBookCategory.MISC,
                100, .7f, "tin_ingot", "raw_tin");
        addBlastingAndSmeltingRecipes(output, CommonItemTags.ORES_TIN, new ItemStack(EnerjoltItems.TIN_INGOT.get()), CookingBookCategory.MISC,
                100, .7f, "tin_ingot", "tin_ores");

        addBlastingAndSmeltingRecipes(output, CommonItemTags.DUSTS_TIN, new ItemStack(EnerjoltItems.TIN_INGOT.get()), CookingBookCategory.MISC,
        ...
        addBlastingAndSmeltingRecipes(output, EnerjoltItems.IRON_HAMMER.get(), new ItemStack(Items.IRON_NUGGET), CookingBookCategory.MISC,
                100, .1f, "iron_nugget", "iron_hammer");
        addBlastingAndSmeltingRecipes(output, EnerjoltItems.GOLDEN_HAMMER.get(), new ItemStack(Items.GOLD_NUGGET), CookingBookCategory.MISC,
                100, .1f, "gold_nugget", "golden_hammer");

        addBlastingAndSmeltingRecipes(output, Tags.Items.GEMS_QUARTZ, new ItemStack(EnerjoltItems.SILICON.get()), CookingBookCategory.MISC,
                250, 4.1f, "silicon", "nether_quartz");

        addSmeltingRecipe(output, EnerjoltBlocks.SAWDUST_BLOCK_ITEM.get(), new ItemStack(Items.CHARCOAL), CookingBookCategory.MISC,
                200, .15f, null, "sawdust_block");

        addSmeltingRecipe(output, EnerjoltItems.RAW_GEAR_PRESS_MOLD.get(), new ItemStack(EnerjoltItems.GEAR_PRESS_MOLD.get()), CookingBookCategory.MISC,
                200, .3f, null);
        addSmeltingRecipe(output, EnerjoltItems.RAW_ROD_PRESS_MOLD.get(), new ItemStack(EnerjoltItems.ROD_PRESS_MOLD.get()), CookingBookCategory.MISC,
                200, .3f, null);
        addSmeltingRecipe(output, EnerjoltItems.RAW_WIRE_PRESS_MOLD.get(), new ItemStack(EnerjoltItems.WIRE_PRESS_MOLD.get()), CookingBookCategory.MISC,
                200, .3f, null);
    }

    private void buildSmithingRecipes(RecipeOutput output) {
        addNetheriteSmithingUpgradeRecipe(output, Ingredient.of(EnerjoltItems.DIAMOND_HAMMER),
                new ItemStack(EnerjoltItems.NETHERITE_HAMMER.get()));
    }

    private void buildPressMoldMakerRecipes(RecipeOutput output) {
        addPressMoldMakerRecipe(output, 4, new ItemStack(EnerjoltItems.RAW_GEAR_PRESS_MOLD.get()));
        addPressMoldMakerRecipe(output, 9, new ItemStack(EnerjoltItems.RAW_ROD_PRESS_MOLD.get()));
        addPressMoldMakerRecipe(output, 6, new ItemStack(EnerjoltItems.RAW_WIRE_PRESS_MOLD.get()));
    }
    ...
    private void buildAlloyFurnaceRecipes(RecipeOutput output) {
        ...
        }, new ItemStack(EnerjoltItems.STEEL_INGOT.get()), 500);
        ...
        }, new ItemStack(EnerjoltItems.REDSTONE_ALLOY_INGOT.get()), 2500);
        ...
        }, new ItemStack(EnerjoltItems.ADVANCED_ALLOY_INGOT.get()), 10000);
    }

    private void buildCompressorRecipes(RecipeOutput output) {
        addCompressorRecipe(output, Ingredient.of(EnerjoltItems.STONE_PEBBLE), new ItemStack(Items.COBBLESTONE),
                16, "stone_pebbles");

        addPlateCompressorRecipes(output, Ingredient.of(CommonItemTags.INGOTS_TIN),
                Ingredient.of(CommonItemTags.STORAGE_BLOCKS_TIN), new ItemStack(EnerjoltItems.TIN_PLATE.get()),
                "tin");
        addPlateCompressorRecipes(output, Ingredient.of(Tags.Items.INGOTS_COPPER),
                Ingredient.of(Tags.Items.STORAGE_BLOCKS_COPPER), new ItemStack(EnerjoltItems.COPPER_PLATE.get()),
                "copper");
        addPlateCompressorRecipes(output, Ingredient.of(Tags.Items.INGOTS_IRON),
                Ingredient.of(Tags.Items.STORAGE_BLOCKS_IRON), new ItemStack(EnerjoltItems.IRON_PLATE.get()),
                "iron");
        addPlateCompressorRecipes(output, Ingredient.of(Tags.Items.INGOTS_GOLD),
                Ingredient.of(Tags.Items.STORAGE_BLOCKS_GOLD), new ItemStack(EnerjoltItems.GOLD_PLATE.get()),
                "gold");

        addPlateCompressorIngotRecipe(output, Ingredient.of(CommonItemTags.INGOTS_ADVANCED_ALLOY),
                new ItemStack(EnerjoltItems.ADVANCED_ALLOY_PLATE.get()), "advanced_alloy");
        addPlateCompressorIngotRecipe(output, Ingredient.of(CommonItemTags.INGOTS_ENERGIZED_COPPER),
                new ItemStack(EnerjoltItems.ENERGIZED_COPPER_PLATE.get()), "energized_copper");
        addPlateCompressorIngotRecipe(output, Ingredient.of(CommonItemTags.INGOTS_ENERGIZED_GOLD),
                new ItemStack(EnerjoltItems.ENERGIZED_GOLD_PLATE.get()), "energized_gold");
    }
    ...
    private void buildPulverizerRecipes(RecipeOutput output) {
        addBasicMetalPulverizerRecipes(output,
                ...
                new ItemStack(EnerjoltItems.TIN_DUST.get()), "tin");
        addBasicMetalPulverizerRecipes(output,
                ...
                new ItemStack(EnerjoltItems.IRON_DUST.get()), "iron");
        addBasicMetalPulverizerRecipes(output,
                ...
                new ItemStack(EnerjoltItems.GOLD_DUST.get()), "gold");

        addPulverizerRecipe(output, Ingredient.of(Tags.Items.ORES_COPPER),
                new PulverizerRecipe.OutputItemStackWithPercentages(new ItemStack(EnerjoltItems.COPPER_DUST.get()), new double[] {
                        1., 1., 1., 1., .5, .5
                }, new double[] {
                        1., 1., 1., 1., .75, .5, .25
                }),
                new PulverizerRecipe.OutputItemStackWithPercentages(new ItemStack(EnerjoltItems.GOLD_DUST.get()),
                        .1, .2), "copper_ores");
        addRawMetalAndIngotPulverizerRecipes(output,
                ...
                new ItemStack(EnerjoltItems.COPPER_DUST.get()), "copper");
        ...
        addPulverizerRecipe(output, Ingredient.of(Items.CHARCOAL),
                new PulverizerRecipe.OutputItemStackWithPercentages(new ItemStack(EnerjoltItems.CHARCOAL_DUST.get()),
                        1., 1.), "charcoal");
    ...
    private void buildSawmillRecipes(RecipeOutput output) {
        ...
        addSawmillRecipe(output, Ingredient.of(EnerjoltItems.WOODEN_HAMMER.get()), new ItemStack(Items.OAK_PLANKS, 2),
        ...
        addSawmillRecipe(output, Ingredient.of(Tags.Items.RODS_WOODEN), new ItemStack(EnerjoltItems.SAWDUST.get()),
                0, "sawdust", "sticks");
    }
    ...
    private void buildPlantGrowthChamberFertilizerRecipes(RecipeOutput output) {
        ...
        addPlantGrowthChamberFertilizerRecipe(output, Ingredient.of(EnerjoltItems.BASIC_FERTILIZER.get()),
                2.5, 3.5, "basic_fertilizer");

        addPlantGrowthChamberFertilizerRecipe(output, Ingredient.of(EnerjoltItems.GOOD_FERTILIZER.get()),
                3.5, 5., "good_fertilizer");

        addPlantGrowthChamberFertilizerRecipe(output, Ingredient.of(EnerjoltItems.ADVANCED_FERTILIZER.get()),
                5., 6.5, "advanced_fertilizer");
    }

    private void buildMetalPressRecipes(RecipeOutput output) {
        addGearMetalPressRecipe(output, Ingredient.of(CommonItemTags.PLATES_IRON), new ItemStack(EnerjoltItems.IRON_GEAR.get()));

        addRodMetalPressRecipe(output, Ingredient.of(CommonItemTags.PLATES_IRON), new ItemStack(EnerjoltItems.IRON_ROD.get()));

        addWireMetalPressRecipe(output, Ingredient.of(CommonItemTags.PLATES_TIN), new ItemStack(EnerjoltItems.TIN_WIRE.get()));
        addWireMetalPressRecipe(output, Ingredient.of(CommonItemTags.PLATES_COPPER), new ItemStack(EnerjoltItems.COPPER_WIRE.get()));
        addWireMetalPressRecipe(output, Ingredient.of(CommonItemTags.PLATES_GOLD), new ItemStack(EnerjoltItems.GOLD_WIRE.get()));

        addWireMetalPressRecipe(output, Ingredient.of(CommonItemTags.PLATES_ENERGIZED_COPPER), new ItemStack(EnerjoltItems.ENERGIZED_COPPER_WIRE.get()));
        addWireMetalPressRecipe(output, Ingredient.of(CommonItemTags.PLATES_ENERGIZED_GOLD), new ItemStack(EnerjoltItems.ENERGIZED_GOLD_WIRE.get()));
    }
    ...
    private void buildAssemblingMachineRecipes(RecipeOutput output) {
        addAssemblingMachineRecipe(output, new IngredientWithCount[] {
                new IngredientWithCount(Ingredient.of(EnerjoltItems.BASIC_SOLAR_CELL), 2),
        ...
        }, new ItemStack(EnerjoltItems.ADVANCED_SOLAR_CELL.get()));

        addAssemblingMachineRecipe(output, new IngredientWithCount[] {
                new IngredientWithCount(Ingredient.of(EnerjoltItems.ADVANCED_SOLAR_CELL), 2),
                new IngredientWithCount(Ingredient.of(EnerjoltItems.ENERGIZED_CRYSTAL_MATRIX), 4),
                new IngredientWithCount(Ingredient.of(CommonItemTags.SILICON), 2),
                new IngredientWithCount(Ingredient.of(Tags.Items.DUSTS_REDSTONE), 2)
        }, new ItemStack(EnerjoltItems.REINFORCED_ADVANCED_SOLAR_CELL.get()));

        addAssemblingMachineRecipe(output, new IngredientWithCount[] {
                new IngredientWithCount(Ingredient.of(EnerjoltItems.BASIC_CIRCUIT), 4),
                ...
                new IngredientWithCount(Ingredient.of(Tags.Items.DUSTS_REDSTONE), 2)
        }, new ItemStack(EnerjoltItems.ADVANCED_CIRCUIT.get()));

        addAssemblingMachineRecipe(output, new IngredientWithCount[] {
                new IngredientWithCount(Ingredient.of(EnerjoltItems.ADVANCED_CIRCUIT), 4),
        ...
        }, new ItemStack(EnerjoltItems.PROCESSING_UNIT.get()));

        addAssemblingMachineRecipe(output, new IngredientWithCount[] {
                new IngredientWithCount(Ingredient.of(EnerjoltItems.PROCESSING_UNIT), 4),
                new IngredientWithCount(Ingredient.of(EnerjoltItems.TELEPORTER_MATRIX), 4),
                new IngredientWithCount(Ingredient.of(EnerjoltItems.ENERGIZED_CRYSTAL_MATRIX), 2),
                new IngredientWithCount(Ingredient.of(CommonItemTags.SILICON), 2)
        }, new ItemStack(EnerjoltItems.TELEPORTER_PROCESSING_UNIT.get()));
        ...
        }, new ItemStack(EnerjoltItems.CRYSTAL_MATRIX.get()));
    }
    ...
    private void buildFiltrationPlantRecipes(RecipeOutput output) {
        addOreFiltrationRecipe(output, new ItemStack(EnerjoltItems.RAW_TIN.get()), 0.05, "tin");
    ...
    private void buildChargerRecipes(RecipeOutput output) {
        addChargerRecipe(output, Ingredient.of(Tags.Items.INGOTS_COPPER),
                new ItemStack(EnerjoltItems.ENERGIZED_COPPER_INGOT.get()), 4194304);
    }

    private void buildEnergizerRecipes(RecipeOutput output) {
        addEnergizerRecipe(output, Ingredient.of(Tags.Items.INGOTS_COPPER),
                new ItemStack(EnerjoltItems.ENERGIZED_COPPER_INGOT.get()), 32768);
        addEnergizerRecipe(output, Ingredient.of(Tags.Items.INGOTS_GOLD),
                new ItemStack(EnerjoltItems.ENERGIZED_GOLD_INGOT.get()), 131072);
        addEnergizerRecipe(output, Ingredient.of(EnerjoltItems.CRYSTAL_MATRIX),
                new ItemStack(EnerjoltItems.ENERGIZED_CRYSTAL_MATRIX.get()), 524288);
    }
    ...
    private static void addShapedCraftingRecipe(RecipeOutput output, Criterion<InventoryChangeTrigger.TriggerInstance> hasIngredientTrigger,
        ...
        ResourceLocation recipeId = EJOLTAPI.id("crafting/" +
    ...
    private static void addSmeltingRecipe(RecipeOutput output, ItemLike ingredient, ItemStack result, CookingBookCategory category,
        ...
        ResourceLocation recipeId = EJOLTAPI.id("smelting/" +
    ...
    private static void addBlastingRecipe(RecipeOutput output, ItemLike ingredient, ItemStack result, CookingBookCategory category,
                                          int time, float xp, String group, String recipeIngredientName) {
        ResourceLocation recipeId = EJOLTAPI.id("blasting/" +
    ...
    private static void addNetheriteSmithingUpgradeRecipe(RecipeOutput recipeOutput, Ingredient base, ItemStack output) {
        ResourceLocation recipeId = EJOLTAPI.id("smithing/" +
    ...
    private static void addAlloyFurnaceRecipe(RecipeOutput recipeOutput, IngredientWithCount[] inputs, ItemStack output,
        ...
        ResourceLocation recipeId = EJOLTAPI.id("alloy_furnace/" +
                getItemName(output.getItem()));
    ...
    private static void addPressMoldMakerRecipe(RecipeOutput recipeOutput, int clayCount, ItemStack output) {
        ResourceLocation recipeId = EJOLTAPI.id("press_mold_maker/" +
                getItemName(output.getItem()));
    ...
    private static void addCompressorRecipe(RecipeOutput recipeOutput, Ingredient input, ItemStack output, int inputCount,
                                            String recipeIngredientName) {
        ResourceLocation recipeId = EJOLTAPI.id("compressing/" +
    ...
    private static void addCrusherRecipe(RecipeOutput recipeOutput, Ingredient input, ItemStack output,
                                         String recipeIngredientName) {
        ResourceLocation recipeId = EJOLTAPI.id("crusher/" +
    ...
    private static void addPulverizerRecipe(RecipeOutput recipeOutput, Ingredient input,
                                            ...
                                            String recipeIngredientName) {
        ResourceLocation recipeId = EJOLTAPI.id("pulverizer/" +
    ...
    private static void addSawmillRecipe(RecipeOutput recipeOutput, Ingredient input, ItemStack output,
        ...
        ResourceLocation recipeId = EJOLTAPI.id("sawmill/" +
    ...
    private static void addPlantGrowthChamberRecipe(RecipeOutput recipeOutput, Ingredient input,
        ...
        ResourceLocation recipeId = EJOLTAPI.id("growing/" +
    ...
    private static void addPlantGrowthChamberFertilizerRecipe(RecipeOutput recipeOutput, Ingredient input,
                                                              ...
                                                              String recipeIngredientName) {
        ResourceLocation recipeId = EJOLTAPI.id("growing/fertilizer/" +
    ...
    private static void addGearMetalPressRecipe(RecipeOutput recipeOutput, Ingredient input, ItemStack output) {
        addMetalPressRecipe(recipeOutput, input, output, new ItemStack(EnerjoltItems.GEAR_PRESS_MOLD.get()), 2);
    }
    private static void addRodMetalPressRecipe(RecipeOutput recipeOutput, Ingredient input, ItemStack output) {
        addMetalPressRecipe(recipeOutput, input, output.copyWithCount(2), new ItemStack(EnerjoltItems.ROD_PRESS_MOLD.get()));
    }
    private static void addWireMetalPressRecipe(RecipeOutput recipeOutput, Ingredient input, ItemStack output) {
        addMetalPressRecipe(recipeOutput, input, output.copyWithCount(3), new ItemStack(EnerjoltItems.WIRE_PRESS_MOLD.get()));
    }
    ...
    private static void addMetalPressRecipe(RecipeOutput recipeOutput, Ingredient input, ItemStack output,
        ...
        ResourceLocation recipeId = EJOLTAPI.id("metal_press/" +
                getItemName(output.getItem()));
    ...
    private static void addHeatGeneratorRecipe(RecipeOutput recipeOutput, Fluid[] input, int energyProduction,
                                               String recipeIngredientName) {
        ResourceLocation recipeId = EJOLTAPI.id("heat_generator/" +
    ...
    private static void addThermalGeneratorRecipe(RecipeOutput recipeOutput, Fluid[] input, int energyProduction,
                                                  String recipeIngredientName) {
        ResourceLocation recipeId = EJOLTAPI.id("thermal_generator/" +
                "energy_production_from_" + recipeIngredientName);
    ...
    private void addStoneLiquefierRecipe(RecipeOutput recipeOutput, Ingredient input, FluidStack output, String recipeIngredientName) {
        ResourceLocation recipeId = EJOLTAPI.id("stone_liquefier/" + recipeIngredientName);
    ...
    private static void addStoneSolidifierRecipe(RecipeOutput recipeOutput, int waterAmount, int lavaAmount, ItemStack output) {
        ResourceLocation recipeId = EJOLTAPI.id("stone_solidifier/" +
                getItemName(output.getItem()));
    ...
    private static void addAssemblingMachineRecipe(RecipeOutput recipeOutput, IngredientWithCount[] inputs, ItemStack output) {
        ResourceLocation recipeId = EJOLTAPI.id("assembling/" +
                getItemName(output.getItem()));
    ...
    private static void addOreFiltrationRecipe(RecipeOutput recipeOutput, ItemStack oreOutput, double oreOutputPercentage,
                                               String oreName) {
        addFiltrationPlantRecipe(recipeOutput, new OutputItemStackWithPercentages(new ItemStack(EnerjoltItems.STONE_PEBBLE.get()), .33),
    ...
    private static void addFiltrationPlantRecipe(RecipeOutput recipeOutput, OutputItemStackWithPercentages output,
                                                 ...
                                                 String recipeName) {
        ResourceLocation recipeId = EJOLTAPI.id("filtration_plant/" +
                recipeName);
    ...
    private static void addFluidTransposerRecipe(RecipeOutput recipeOutput, Ingredient input, ItemStack output,
        ...
        ResourceLocation recipeId = EJOLTAPI.id("fluid_transposer/" +
                getItemName(output.getItem()));
    ...
    private static void addChargerRecipe(RecipeOutput recipeOutput, Ingredient input, ItemStack output, int energyConsumption) {
        ResourceLocation recipeId = EJOLTAPI.id("charger/" +
                getItemName(output.getItem()));
    ...
    private static void addEnergizerRecipe(RecipeOutput recipeOutput, Ingredient input, ItemStack output, int energyConsumption) {
        ResourceLocation recipeId = EJOLTAPI.id("energizer/" +
                getItemName(output.getItem()));
    ...
    private static void addCrystalGrowthChamberRecipe(RecipeOutput recipeOutput, Ingredient input, OutputItemStackWithPercentages output,
        ...
        ResourceLocation recipeId = EJOLTAPI.id("crystal_growing/" +
