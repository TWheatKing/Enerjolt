...
import me.twheatking.enerjolt.screen.MinecartBatteryBoxMenu;
...
public class MinecartBatteryBox extends AbstractMinecartBatteryBox {
    ...
    public MinecartBatteryBox(Level level, double x, double y, double z) {
        super(EnerjoltEntityTypes.BATTERY_BOX_MINECART.get(), level, x, y, z);
    }

    @Override
    protected Item getDropItem() {
        return EnerjoltItems.BATTERY_BOX_MINECART.get();
    }

    public BlockState getDefaultDisplayBlockState() {
        return EnerjoltBlocks.BATTERY_BOX.get().defaultBlockState();
    }
    ...
    public ItemStack getPickResult() {
        return new ItemStack(EnerjoltItems.BATTERY_BOX_MINECART.get());
    }
}
