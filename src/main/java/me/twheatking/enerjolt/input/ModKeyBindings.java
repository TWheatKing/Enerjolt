...
public final class ModKeyBindings {
    ...
    public static final String KEY_CATEGORY_ENERGIZED_POWER = "key.category.enerjolt";
    public static final String KEY_TELEPORTER_USE = "key.enerjolt.teleporter.use";
