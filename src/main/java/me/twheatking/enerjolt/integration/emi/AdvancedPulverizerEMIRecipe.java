...
public class AdvancedPulverizerEMIRecipe implements EmiRecipe {
    public static final ResourceLocation SIMPLIFIED_TEXTURE = EJOLTAPI.id("textures/block/advanced_pulverizer_side.png");
    public static final EmiStack ITEM = EmiStack.of(EnerjoltBlocks.ADVANCED_PULVERIZER_ITEM.get());
    public static final EmiRecipeCategory CATEGORY = new EmiRecipeCategory(EJOLTAPI.id("advanced_pulverizer"),
