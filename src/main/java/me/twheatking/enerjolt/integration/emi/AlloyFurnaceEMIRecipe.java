...
import me.twheatking.enerjolt.block.entity.AlloyFurnaceBlockEntity;
import me.twheatking.enerjolt.recipe.AlloyFurnaceRecipe;
...
public class AlloyFurnaceEMIRecipe implements EmiRecipe {
    public static final ResourceLocation SIMPLIFIED_TEXTURE = EJOLTAPI.id("textures/block/alloy_furnace_front.png");
    public static final EmiStack ITEM = EmiStack.of(EnerjoltBlocks.ALLOY_FURNACE_ITEM.get());
    public static final EmiRecipeCategory CATEGORY = new EmiRecipeCategory(EJOLTAPI.id("alloy_furnace"),
