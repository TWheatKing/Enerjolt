...
public class AssemblingMachineEMIRecipe implements EmiRecipe {
    public static final ResourceLocation SIMPLIFIED_TEXTURE = EJOLTAPI.id("textures/block/assembling_machine_front.png");
    public static final EmiStack ITEM = EmiStack.of(EnerjoltBlocks.ASSEMBLING_MACHINE_ITEM.get());
    public static final EmiRecipeCategory CATEGORY = new EmiRecipeCategory(EJOLTAPI.id("assembling_machine"),
