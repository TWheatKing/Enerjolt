...
import me.twheatking.enerjolt.block.entity.ChargerBlockEntity;
import me.twheatking.enerjolt.recipe.ChargerRecipe;
...
public class ChargerEMIRecipe implements EmiRecipe {
    public static final ResourceLocation SIMPLIFIED_TEXTURE = EJOLTAPI.id("textures/block/charger_side.png");
    public static final EmiStack ITEM = EmiStack.of(EnerjoltBlocks.CHARGER_ITEM.get());
    public static final EmiRecipeCategory CATEGORY = new EmiRecipeCategory(EJOLTAPI.id("charger"),
    ...
    public void addWidgets(WidgetHolder widgets) {
        ResourceLocation texture = EJOLTAPI.id("textures/gui/container/charger.png");
