...
import me.twheatking.enerjolt.block.entity.CrystalGrowthChamberBlockEntity;
...
public class CrystalGrowthChamberEMIRecipe implements EmiRecipe {
    public static final ResourceLocation SIMPLIFIED_TEXTURE = EJOLTAPI.id("textures/block/crystal_growth_chamber_side.png");
    public static final EmiStack ITEM = EmiStack.of(EnerjoltBlocks.CRYSTAL_GROWTH_CHAMBER_ITEM.get());
    public static final EmiRecipeCategory CATEGORY = new EmiRecipeCategory(EJOLTAPI.id("crystal_growth_chamber"),
