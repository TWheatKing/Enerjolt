...
public class EnergizerEMIRecipe implements EmiRecipe {
    public static final ResourceLocation SIMPLIFIED_TEXTURE = EJOLTAPI.id("textures/block/energizer_front.png");
    public static final EmiStack ITEM = EmiStack.of(EnerjoltBlocks.ENERGIZER_ITEM.get());
    public static final EmiRecipeCategory CATEGORY = new EmiRecipeCategory(EJOLTAPI.id("energizer"),
