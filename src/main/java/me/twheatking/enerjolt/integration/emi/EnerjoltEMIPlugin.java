...
@EmiEntrypoint
public class EnerjoltEMIPlugin implements EmiPlugin {
    ...
    private void registerCategories(EmiRegistry registry) {
        registry.addWorkstation(VanillaEmiRecipeCategories.CRAFTING, EmiStack.of(EnerjoltBlocks.AUTO_CRAFTER_ITEM.get()));

        registry.addWorkstation(VanillaEmiRecipeCategories.CRAFTING, EmiStack.of(EnerjoltBlocks.ADVANCED_AUTO_CRAFTER_ITEM.get()));

        registry.addWorkstation(VanillaEmiRecipeCategories.SMELTING, EmiStack.of(EnerjoltBlocks.POWERED_FURNACE_ITEM.get()));
        registry.addWorkstation(VanillaEmiRecipeCategories.BLASTING, EmiStack.of(EnerjoltBlocks.POWERED_FURNACE_ITEM.get()));
        registry.addWorkstation(VanillaEmiRecipeCategories.SMOKING, EmiStack.of(EnerjoltBlocks.POWERED_FURNACE_ITEM.get()));

        registry.addWorkstation(VanillaEmiRecipeCategories.SMELTING, EmiStack.of(EnerjoltBlocks.ADVANCED_POWERED_FURNACE_ITEM.get()));
        registry.addWorkstation(VanillaEmiRecipeCategories.BLASTING, EmiStack.of(EnerjoltBlocks.ADVANCED_POWERED_FURNACE_ITEM.get()));
        registry.addWorkstation(VanillaEmiRecipeCategories.SMOKING, EmiStack.of(EnerjoltBlocks.ADVANCED_POWERED_FURNACE_ITEM.get()));

        registry.addWorkstation(VanillaEmiRecipeCategories.STONECUTTING, EmiStack.of(EnerjoltBlocks.AUTO_STONECUTTER_ITEM.get()));

        registry.addWorkstation(VanillaEmiRecipeCategories.FUEL, EmiStack.of(EnerjoltBlocks.COAL_ENGINE_ITEM.get()));

        registry.addWorkstation(VanillaEmiRecipeCategories.FUEL, EmiStack.of(EnerjoltItems.INVENTORY_COAL_ENGINE.get()));

        registry.addCategory(ChargerEMIRecipe.CATEGORY);
        registry.addWorkstation(ChargerEMIRecipe.CATEGORY, ChargerEMIRecipe.ITEM);
        registry.addWorkstation(ChargerEMIRecipe.CATEGORY, EmiStack.of(EnerjoltBlocks.ADVANCED_CHARGER_ITEM.get()));

        registry.addCategory(CrusherEMIRecipe.CATEGORY);
        registry.addWorkstation(CrusherEMIRecipe.CATEGORY, CrusherEMIRecipe.ITEM);
        registry.addWorkstation(CrusherEMIRecipe.CATEGORY, EmiStack.of(EnerjoltBlocks.ADVANCED_CRUSHER_ITEM.get()));
        ...
        registry.addWorkstation(PressMoldMakerEMIRecipe.CATEGORY, EmiStack.of(EnerjoltBlocks.AUTO_PRESS_MOLD_MAKER_ITEM.get()));
        ...
        registry.addWorkstation(AlloyFurnaceEMIRecipe.CATEGORY, EmiStack.of(EnerjoltBlocks.INDUCTION_SMELTER_ITEM.get()));
    ...
    private void registerRecipes(EmiRegistry registry) {
        ...
        registry.addRecipe(new DispenserEMIRecipe(new DispenserEMIRecipe.DispenserRecipe(
                EJOLTAPI.id("dispenser/energizedpower/cable_insulator"),
        ...
        registry.addRecipe(new InWorldEMIRecipe(new InWorldEMIRecipe.InWorldRecipe(
                EJOLTAPI.id("in_world_crafting/energizedpower/cable_insulator"),
                Ingredient.of(Tags.Items.TOOLS_SHEAR), Ingredient.of(ItemTags.WOOL),
                new ItemStack(EnerjoltItems.CABLE_INSULATOR.get(), 18))));
    }

    private void registerRecipeHandlers(EmiRegistry registry) {
        registry.addRecipeHandler(EnerjoltMenuTypes.AUTO_CRAFTER_MENU.get(), new AutoCrafterRecipeHandler());

        registry.addRecipeHandler(EnerjoltMenuTypes.ADVANCED_AUTO_CRAFTER_MENU.get(), new AdvancedAutoCrafterRecipeHandler());

        registry.addRecipeHandler(EnerjoltMenuTypes.AUTO_PRESS_MOLD_MAKER_MENU.get(),
                new SelectableRecipeMachineRecipeHandler<>(PressMoldMakerEMIRecipe.CATEGORY));

        registry.addRecipeHandler(EnerjoltMenuTypes.AUTO_STONECUTTER_MENU.get(),
                new SelectableRecipeMachineRecipeHandler<>(VanillaEmiRecipeCategories.STONECUTTING));

        registry.addRecipeHandler(EnerjoltMenuTypes.STONE_SOLIDIFIER_MENU.get(),
                new SelectableRecipeMachineRecipeHandler<>(StoneSolidifierEMIRecipe.CATEGORY));

        registry.addRecipeHandler(EnerjoltMenuTypes.FILTRATION_PLANT_MENU.get(),
