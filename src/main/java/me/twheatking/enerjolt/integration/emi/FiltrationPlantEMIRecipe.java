...
public class FiltrationPlantEMIRecipe implements EmiRecipe {
    public static final ResourceLocation SIMPLIFIED_TEXTURE = EJOLTAPI.id("textures/block/filtration_plant_front.png");
    public static final EmiStack ITEM = EmiStack.of(EnerjoltBlocks.FILTRATION_PLANT_ITEM.get());
    public static final EmiRecipeCategory CATEGORY = new EmiRecipeCategory(EJOLTAPI.id("filtration_plant"),
    ...
    public FiltrationPlantEMIRecipe(RecipeHolder<FiltrationPlantRecipe> recipe) {
        this.id = recipe.id();
        this.input = List.of(EmiStack.of(EnerjoltFluids.DIRTY_WATER.get(), FiltrationPlantBlockEntity.DIRTY_WATER_CONSUMPTION_PER_RECIPE));
