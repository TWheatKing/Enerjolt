...
public class FluidTransposerEMIRecipe implements EmiRecipe {
    public static final ResourceLocation SIMPLIFIED_TEXTURE = EJOLTAPI.id("textures/block/fluid_transposer_front.png");
    public static final EmiStack ITEM = EmiStack.of(EnerjoltBlocks.FLUID_TRANSPOSER_ITEM.get());
    public static final EmiRecipeCategory CATEGORY = new EmiRecipeCategory(EJOLTAPI.id("fluid_transposer"),
    ...
    public void addWidgets(WidgetHolder widgets) {
        if(mode == FluidTransposerBlockEntity.Mode.EMPTYING) {
            widgets.addTexture(EJOLTAPI.id("textures/gui/recipe/misc_gui.png"),
                    0, 0, 143, 26, 1, 133);
