...
public class PressMoldMakerEMIRecipe implements EmiRecipe {
    public static final ResourceLocation SIMPLIFIED_TEXTURE = EJOLTAPI.id("textures/block/press_mold_maker_front.png");
    public static final EmiStack ITEM = EmiStack.of(EnerjoltBlocks.PRESS_MOLD_MAKER_ITEM.get());
    public static final EmiRecipeCategory CATEGORY = new EmiRecipeCategory(EJOLTAPI.id("press_mold_maker"),
