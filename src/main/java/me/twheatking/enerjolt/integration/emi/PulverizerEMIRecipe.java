...
public class PulverizerEMIRecipe implements EmiRecipe {
    public static final ResourceLocation SIMPLIFIED_TEXTURE = EJOLTAPI.id("textures/block/pulverizer_side.png");
    public static final EmiStack ITEM = EmiStack.of(EnerjoltBlocks.PULVERIZER_ITEM.get());
    public static final EmiRecipeCategory CATEGORY = new EmiRecipeCategory(EJOLTAPI.id("pulverizer"),
