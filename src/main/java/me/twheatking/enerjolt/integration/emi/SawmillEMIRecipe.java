...
public class SawmillEMIRecipe implements EmiRecipe {
    public static final ResourceLocation SIMPLIFIED_TEXTURE = EJOLTAPI.id("textures/block/sawmill_side.png");
    public static final EmiStack ITEM = EmiStack.of(EnerjoltBlocks.SAWMILL_ITEM.get());
    public static final EmiRecipeCategory CATEGORY = new EmiRecipeCategory(EJOLTAPI.id("sawmill"),
