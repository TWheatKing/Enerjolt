...
public class StoneSolidifierEMIRecipe implements EmiRecipe {
    public static final ResourceLocation SIMPLIFIED_TEXTURE = EJOLTAPI.id("textures/block/stone_solidifier_front.png");
    public static final EmiStack ITEM = EmiStack.of(EnerjoltBlocks.STONE_SOLIDIFIER_ITEM.get());
    public static final EmiRecipeCategory CATEGORY = new EmiRecipeCategory(EJOLTAPI.id("stone_solidifier"),
