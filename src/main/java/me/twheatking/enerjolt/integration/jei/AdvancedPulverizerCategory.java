...
public class AdvancedPulverizerCategory implements IRecipeCategory<RecipeHolder<PulverizerRecipe>> {
    public static final RecipeType<RecipeHolder<PulverizerRecipe>> TYPE = new RecipeType<>(EJOLTAPI.id("advanced_pulverizer"),
    ...
    public AdvancedPulverizerCategory(IGuiHelper helper) {
        ...
        icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(EnerjoltBlocks.ADVANCED_PULVERIZER_ITEM.get()));
    }
