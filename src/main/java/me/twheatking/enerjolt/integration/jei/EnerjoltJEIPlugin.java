...
import me.twheatking.enerjolt.screen.base.IUpgradeModuleMenu;
...
public class EnerjoltJEIPlugin implements IModPlugin {
    @Override
    public ResourceLocation getPluginUid() {
        return EJOLTAPI.id("jei_plugin");
    }
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        registration.addRecipes(InWorldCategory.TYPE, Arrays.asList(
                new InWorldCategory.InWorldRecipe(Ingredient.of(Tags.Items.TOOLS_SHEAR), Ingredient.of(ItemTags.WOOL),
                        new ItemStack(EnerjoltItems.CABLE_INSULATOR.get(), 18))
        ));
    ...
    public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
        registration.addRecipeCatalyst(new ItemStack(EnerjoltBlocks.AUTO_CRAFTER_ITEM.get()), RecipeTypes.CRAFTING);

        registration.addRecipeCatalyst(new ItemStack(EnerjoltBlocks.ADVANCED_AUTO_CRAFTER_ITEM.get()), RecipeTypes.CRAFTING);

        registration.addRecipeCatalyst(new ItemStack(EnerjoltBlocks.POWERED_FURNACE_ITEM.get()), RecipeTypes.SMELTING);
        registration.addRecipeCatalyst(new ItemStack(EnerjoltBlocks.POWERED_FURNACE_ITEM.get()), RecipeTypes.BLASTING);
        registration.addRecipeCatalyst(new ItemStack(EnerjoltBlocks.POWERED_FURNACE_ITEM.get()), RecipeTypes.SMOKING);

        registration.addRecipeCatalyst(new ItemStack(EnerjoltBlocks.ADVANCED_POWERED_FURNACE_ITEM.get()), RecipeTypes.SMELTING);
        registration.addRecipeCatalyst(new ItemStack(EnerjoltBlocks.ADVANCED_POWERED_FURNACE_ITEM.get()), RecipeTypes.BLASTING);
        registration.addRecipeCatalyst(new ItemStack(EnerjoltBlocks.ADVANCED_POWERED_FURNACE_ITEM.get()), RecipeTypes.SMOKING);

        registration.addRecipeCatalyst(new ItemStack(EnerjoltBlocks.AUTO_STONECUTTER_ITEM.get()), RecipeTypes.STONECUTTING);

        registration.addRecipeCatalyst(new ItemStack(EnerjoltBlocks.COAL_ENGINE_ITEM.get()), RecipeTypes.FUELING);

        registration.addRecipeCatalyst(new ItemStack(EnerjoltItems.INVENTORY_COAL_ENGINE.get()), RecipeTypes.FUELING);

        registration.addRecipeCatalyst(new ItemStack(EnerjoltBlocks.CHARGER_ITEM.get()), ChargerCategory.TYPE);
        registration.addRecipeCatalyst(new ItemStack(EnerjoltBlocks.ADVANCED_CHARGER_ITEM.get()), ChargerCategory.TYPE);
        registration.addRecipeCatalyst(new ItemStack(EnerjoltBlocks.CRUSHER_ITEM.get()), CrusherCategory.TYPE);
        registration.addRecipeCatalyst(new ItemStack(EnerjoltBlocks.ADVANCED_CRUSHER_ITEM.get()), CrusherCategory.TYPE);
        registration.addRecipeCatalyst(new ItemStack(EnerjoltBlocks.PULVERIZER_ITEM.get()), PulverizerCategory.TYPE);
        registration.addRecipeCatalyst(new ItemStack(EnerjoltBlocks.ADVANCED_PULVERIZER_ITEM.get()), AdvancedPulverizerCategory.TYPE);
        registration.addRecipeCatalyst(new ItemStack(EnerjoltBlocks.SAWMILL_ITEM.get()), SawmillCategory.TYPE);
        registration.addRecipeCatalyst(new ItemStack(EnerjoltBlocks.COMPRESSOR_ITEM.get()), CompressorCategory.TYPE);
        registration.addRecipeCatalyst(new ItemStack(EnerjoltBlocks.METAL_PRESS_ITEM.get()), MetalPressCategory.TYPE);
        registration.addRecipeCatalyst(new ItemStack(EnerjoltBlocks.ASSEMBLING_MACHINE_ITEM.get()), AssemblingMachineCategory.TYPE);
        registration.addRecipeCatalyst(new ItemStack(EnerjoltBlocks.PLANT_GROWTH_CHAMBER_ITEM.get()), PlantGrowthChamberCategory.TYPE);
        registration.addRecipeCatalyst(new ItemStack(EnerjoltBlocks.PLANT_GROWTH_CHAMBER_ITEM.get()), PlantGrowthChamberFertilizerCategory.TYPE);
        registration.addRecipeCatalyst(new ItemStack(EnerjoltBlocks.ENERGIZER_ITEM.get()), EnergizerCategory.TYPE);
        registration.addRecipeCatalyst(new ItemStack(EnerjoltBlocks.CRYSTAL_GROWTH_CHAMBER_ITEM.get()), CrystalGrowthChamberCategory.TYPE);
        registration.addRecipeCatalyst(new ItemStack(EnerjoltBlocks.PRESS_MOLD_MAKER_ITEM.get()), PressMoldMakerCategory.TYPE);
        registration.addRecipeCatalyst(new ItemStack(EnerjoltBlocks.AUTO_PRESS_MOLD_MAKER_ITEM.get()), PressMoldMakerCategory.TYPE);
        registration.addRecipeCatalyst(new ItemStack(EnerjoltBlocks.ALLOY_FURNACE_ITEM.get()), AlloyFurnaceCategory.TYPE);
        registration.addRecipeCatalyst(new ItemStack(EnerjoltBlocks.INDUCTION_SMELTER_ITEM.get()), AlloyFurnaceCategory.TYPE);
        registration.addRecipeCatalyst(new ItemStack(EnerjoltBlocks.STONE_LIQUEFIER_ITEM.get()), StoneLiquefierCategory.TYPE);
        registration.addRecipeCatalyst(new ItemStack(EnerjoltBlocks.STONE_SOLIDIFIER_ITEM.get()), StoneSolidifierCategory.TYPE);
        registration.addRecipeCatalyst(new ItemStack(EnerjoltBlocks.FILTRATION_PLANT_ITEM.get()), FiltrationPlantCategory.TYPE);
        registration.addRecipeCatalyst(new ItemStack(EnerjoltBlocks.FLUID_TRANSPOSER_ITEM.get()), FluidTransposerCategory.TYPE);
