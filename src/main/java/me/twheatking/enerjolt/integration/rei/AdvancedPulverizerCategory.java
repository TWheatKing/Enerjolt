...
public class AdvancedPulverizerCategory implements DisplayCategory<AdvancedPulverizerDisplay> {
    public static final CategoryIdentifier<AdvancedPulverizerDisplay> CATEGORY = CategoryIdentifier.of(EJOLTAPI.MOD_ID, "advanced_pulverizer");
    ...
    public Renderer getIcon() {
        return EntryStacks.of(EnerjoltBlocks.ADVANCED_PULVERIZER_ITEM.get());
    }
