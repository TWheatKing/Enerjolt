...
public class AlloyFurnaceCategory implements DisplayCategory<AlloyFurnaceDisplay> {
    public static final CategoryIdentifier<AlloyFurnaceDisplay> CATEGORY = CategoryIdentifier.of(EJOLTAPI.MOD_ID, "alloy_furnace");
    ...
    public Renderer getIcon() {
        return EntryStacks.of(EnerjoltBlocks.ALLOY_FURNACE_ITEM.get());
    }
