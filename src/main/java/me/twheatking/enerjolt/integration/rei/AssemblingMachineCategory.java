...
public class AssemblingMachineCategory implements DisplayCategory<AssemblingMachineDisplay> {
    public static final CategoryIdentifier<AssemblingMachineDisplay> CATEGORY = CategoryIdentifier.of(EJOLTAPI.MOD_ID, "assembling_machine");
    ...
    public Renderer getIcon() {
        return EntryStacks.of(EnerjoltBlocks.ASSEMBLING_MACHINE_ITEM.get());
    }
