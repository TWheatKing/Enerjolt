...
public class ChargerCategory implements DisplayCategory<ChargerDisplay> {
    public static final CategoryIdentifier<ChargerDisplay> CATEGORY = CategoryIdentifier.of(EJOLTAPI.MOD_ID, "charger");
    ...
    public Renderer getIcon() {
        return EntryStacks.of(EnerjoltBlocks.CHARGER_ITEM.get());
    }
