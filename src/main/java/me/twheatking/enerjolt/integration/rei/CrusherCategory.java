...
public class CrusherCategory implements DisplayCategory<CrusherDisplay> {
    public static final CategoryIdentifier<CrusherDisplay> CATEGORY = CategoryIdentifier.of(EJOLTAPI.MOD_ID, "crusher");
    ...
    public Renderer getIcon() {
        return EntryStacks.of(EnerjoltBlocks.CRUSHER_ITEM.get());
    }
