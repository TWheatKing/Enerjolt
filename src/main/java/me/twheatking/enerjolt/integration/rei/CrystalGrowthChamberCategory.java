...
public class CrystalGrowthChamberCategory implements DisplayCategory<CrystalGrowthChamberDisplay> {
    public static final CategoryIdentifier<CrystalGrowthChamberDisplay> CATEGORY = CategoryIdentifier.of(EJOLTAPI.MOD_ID, "crystal_growth_chamber");
    ...
    public Renderer getIcon() {
        return EntryStacks.of(EnerjoltBlocks.CRYSTAL_GROWTH_CHAMBER_ITEM.get());
    }
