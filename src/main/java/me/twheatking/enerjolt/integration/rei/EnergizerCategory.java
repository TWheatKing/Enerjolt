...
public class EnergizerCategory implements DisplayCategory<EnergizerDisplay> {
    public static final CategoryIdentifier<EnergizerDisplay> CATEGORY = CategoryIdentifier.of(EJOLTAPI.MOD_ID, "energizer");
    ...
    public Renderer getIcon() {
        return EntryStacks.of(EnerjoltBlocks.ENERGIZER_ITEM.get());
    }
