...
public class EnerjoltREIPlugin implements REIClientPlugin {
    @Override
    ...
    public void registerCategories(CategoryRegistry registry) {
        registry.addWorkstations(BuiltinPlugin.CRAFTING, EntryStacks.of(EnerjoltBlocks.AUTO_CRAFTER_ITEM.get()));

        registry.addWorkstations(BuiltinPlugin.CRAFTING, EntryStacks.of(EnerjoltBlocks.ADVANCED_AUTO_CRAFTER_ITEM.get()));

        registry.addWorkstations(BuiltinPlugin.SMELTING, EntryStacks.of(EnerjoltBlocks.POWERED_FURNACE_ITEM.get()));
        registry.addWorkstations(BuiltinPlugin.BLASTING, EntryStacks.of(EnerjoltBlocks.POWERED_FURNACE_ITEM.get()));
        registry.addWorkstations(BuiltinPlugin.SMOKING, EntryStacks.of(EnerjoltBlocks.POWERED_FURNACE_ITEM.get()));

        registry.addWorkstations(BuiltinPlugin.SMELTING, EntryStacks.of(EnerjoltBlocks.ADVANCED_POWERED_FURNACE_ITEM.get()));
        registry.addWorkstations(BuiltinPlugin.BLASTING, EntryStacks.of(EnerjoltBlocks.ADVANCED_POWERED_FURNACE_ITEM.get()));
        registry.addWorkstations(BuiltinPlugin.SMOKING, EntryStacks.of(EnerjoltBlocks.ADVANCED_POWERED_FURNACE_ITEM.get()));

        registry.addWorkstations(BuiltinPlugin.STONE_CUTTING, EntryStacks.of(EnerjoltBlocks.AUTO_STONECUTTER_ITEM.get()));

        registry.addWorkstations(BuiltinPlugin.FUEL, EntryStacks.of(EnerjoltBlocks.COAL_ENGINE_ITEM.get()));

        registry.addWorkstations(BuiltinPlugin.FUEL, EntryStacks.of(EnerjoltItems.INVENTORY_COAL_ENGINE.get()));

        registry.add(new ChargerCategory());
        registry.addWorkstations(ChargerCategory.CATEGORY, EntryStacks.of(EnerjoltBlocks.CHARGER_ITEM.get()),
                EntryStacks.of(EnerjoltBlocks.ADVANCED_CHARGER_ITEM.get()));

        registry.add(new CrusherCategory());
        registry.addWorkstations(CrusherCategory.CATEGORY, EntryStacks.of(EnerjoltBlocks.CRUSHER_ITEM.get()),
                EntryStacks.of(EnerjoltBlocks.ADVANCED_CRUSHER_ITEM.get()));

        registry.add(new PulverizerCategory());
        registry.addWorkstations(PulverizerCategory.CATEGORY, EntryStacks.of(EnerjoltBlocks.PULVERIZER_ITEM.get()));

        registry.add(new AdvancedPulverizerCategory());
        registry.addWorkstations(AdvancedPulverizerCategory.CATEGORY, EntryStacks.of(EnerjoltBlocks.ADVANCED_PULVERIZER_ITEM.get()));

        registry.add(new SawmillCategory());
        registry.addWorkstations(SawmillCategory.CATEGORY, EntryStacks.of(EnerjoltBlocks.SAWMILL_ITEM.get()));

        registry.add(new CompressorCategory());
        registry.addWorkstations(CompressorCategory.CATEGORY, EntryStacks.of(EnerjoltBlocks.COMPRESSOR_ITEM.get()));

        registry.add(new MetalPressCategory());
        registry.addWorkstations(MetalPressCategory.CATEGORY, EntryStacks.of(EnerjoltBlocks.METAL_PRESS_ITEM.get()));

        registry.add(new AssemblingMachineCategory());
        registry.addWorkstations(AssemblingMachineCategory.CATEGORY, EntryStacks.of(EnerjoltBlocks.ASSEMBLING_MACHINE_ITEM.get()));

        registry.add(new PlantGrowthChamberCategory());
        registry.addWorkstations(PlantGrowthChamberCategory.CATEGORY, EntryStacks.of(EnerjoltBlocks.PLANT_GROWTH_CHAMBER_ITEM.get()));

        registry.add(new PlantGrowthChamberFertilizerCategory());
        registry.addWorkstations(PlantGrowthChamberFertilizerCategory.CATEGORY, EntryStacks.of(EnerjoltBlocks.PLANT_GROWTH_CHAMBER_ITEM.get()));

        registry.add(new EnergizerCategory());
        registry.addWorkstations(EnergizerCategory.CATEGORY, EntryStacks.of(EnerjoltBlocks.ENERGIZER_ITEM.get()));

        registry.add(new CrystalGrowthChamberCategory());
        registry.addWorkstations(CrystalGrowthChamberCategory.CATEGORY, EntryStacks.of(EnerjoltBlocks.CRYSTAL_GROWTH_CHAMBER_ITEM.get()));

        registry.add(new PressMoldMakerCategory());
        registry.addWorkstations(PressMoldMakerCategory.CATEGORY, EntryStacks.of(EnerjoltBlocks.PRESS_MOLD_MAKER_ITEM.get()));
        registry.addWorkstations(PressMoldMakerCategory.CATEGORY, EntryStacks.of(EnerjoltBlocks.AUTO_PRESS_MOLD_MAKER_ITEM.get()));

        registry.add(new AlloyFurnaceCategory());
        registry.addWorkstations(AlloyFurnaceCategory.CATEGORY, EntryStacks.of(EnerjoltBlocks.ALLOY_FURNACE_ITEM.get()));
        registry.addWorkstations(AlloyFurnaceCategory.CATEGORY, EntryStacks.of(EnerjoltBlocks.INDUCTION_SMELTER_ITEM.get()));

        registry.add(new StoneLiquefierCategory());
        registry.addWorkstations(StoneLiquefierDisplay.CATEGORY, EntryStacks.of(EnerjoltBlocks.STONE_LIQUEFIER_ITEM));

        registry.add(new StoneSolidifierCategory());
        registry.addWorkstations(StoneSolidifierCategory.CATEGORY, EntryStacks.of(EnerjoltBlocks.STONE_SOLIDIFIER_ITEM.get()));

        registry.add(new FiltrationPlantCategory());
        registry.addWorkstations(FiltrationPlantCategory.CATEGORY, EntryStacks.of(EnerjoltBlocks.FILTRATION_PLANT_ITEM.get()));

        registry.add(new FluidTransposerCategory());
        registry.addWorkstations(FluidTransposerCategory.CATEGORY, EntryStacks.of(EnerjoltBlocks.FLUID_TRANSPOSER_ITEM.get()));
    ...
    public void registerDisplays(DisplayRegistry registry) {
        ...
        registry.registerRecipeFiller(StoneLiquefierRecipe.class, EnerjoltRecipes.STONE_LIQUEFIER_TYPE.get(), StoneLiquefierDisplay::new);
