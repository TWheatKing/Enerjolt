...
public class FiltrationPlantCategory implements DisplayCategory<FiltrationPlantDisplay> {
    public static final CategoryIdentifier<FiltrationPlantDisplay> CATEGORY = CategoryIdentifier.of(EJOLTAPI.MOD_ID, "filtration_plant");
    ...
    public Renderer getIcon() {
        return EntryStacks.of(EnerjoltBlocks.FILTRATION_PLANT_ITEM.get());
    }
