...
public class FluidTransposerCategory implements DisplayCategory<FluidTransposerDisplay> {
    public static final CategoryIdentifier<FluidTransposerDisplay> CATEGORY = CategoryIdentifier.of(EJOLTAPI.MOD_ID, "fluid_transposer");
    ...
    public Renderer getIcon() {
        return EntryStacks.of(EnerjoltBlocks.FLUID_TRANSPOSER_ITEM.get());
    }
