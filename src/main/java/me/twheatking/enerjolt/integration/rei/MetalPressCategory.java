...
public class MetalPressCategory implements DisplayCategory<MetalPressDisplay> {
    public static final CategoryIdentifier<MetalPressDisplay> CATEGORY = CategoryIdentifier.of(EJOLTAPI.MOD_ID, "metal_press");
    ...
    public Renderer getIcon() {
        return EntryStacks.of(EnerjoltBlocks.METAL_PRESS_ITEM.get());
    }
