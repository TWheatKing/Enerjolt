...
public class PlantGrowthChamberFertilizerCategory implements DisplayCategory<PlantGrowthChamberFertilizerDisplay> {
    public static final CategoryIdentifier<PlantGrowthChamberFertilizerDisplay> CATEGORY = CategoryIdentifier.of(EJOLTAPI.MOD_ID, "plant_growth_chamber_fertilizer");
    ...
    public Renderer getIcon() {
        return EntryStacks.of(EnerjoltBlocks.PLANT_GROWTH_CHAMBER_ITEM.get());
    }
    ...
    public List<Widget> setupDisplay(PlantGrowthChamberFertilizerDisplay display, Rectangle bounds) {
        ...
        widgets.add(Widgets.createLabel(new Point(x + bounds.width - 10, y + bounds.height - 34),
                        Component.translatable("recipes.enerjolt.plant_growth_chamber_fertilizer.speed_multiplier",
        ...
        widgets.add(Widgets.createLabel(new Point(x + bounds.width - 10, y + bounds.height - 17),
                        Component.translatable("recipes.enerjolt.plant_growth_chamber_fertilizer.energy_consumption_multiplier",
