...
public class PressMoldMakerCategory implements DisplayCategory<PressMoldMakerDisplay> {
    public static final CategoryIdentifier<PressMoldMakerDisplay> CATEGORY = CategoryIdentifier.of(EJOLTAPI.MOD_ID, "press_mold_maker");
    ...
    public Renderer getIcon() {
        return EntryStacks.of(EnerjoltBlocks.PRESS_MOLD_MAKER_ITEM.get());
    }
