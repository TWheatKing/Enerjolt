...
public class PulverizerCategory implements DisplayCategory<PulverizerDisplay> {
    public static final CategoryIdentifier<PulverizerDisplay> CATEGORY = CategoryIdentifier.of(EJOLTAPI.MOD_ID, "pulverizer");
    ...
    public Renderer getIcon() {
        return EntryStacks.of(EnerjoltBlocks.PULVERIZER_ITEM.get());
    }
