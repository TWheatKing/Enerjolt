...
public class SawmillCategory implements DisplayCategory<SawmillDisplay> {
    public static final CategoryIdentifier<SawmillDisplay> CATEGORY = CategoryIdentifier.of(EJOLTAPI.MOD_ID, "sawmill");
    ...
    public Renderer getIcon() {
        return EntryStacks.of(EnerjoltBlocks.SAWMILL_ITEM.get());
    }
