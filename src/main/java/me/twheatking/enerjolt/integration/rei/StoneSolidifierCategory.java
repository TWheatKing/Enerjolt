...
public class StoneSolidifierCategory implements DisplayCategory<StoneSolidifierDisplay> {
    public static final CategoryIdentifier<StoneSolidifierDisplay> CATEGORY = CategoryIdentifier.of(EJOLTAPI.MOD_ID, "stone_solidifier");
    ...
    public Renderer getIcon() {
        return EntryStacks.of(EnerjoltBlocks.STONE_SOLIDIFIER_ITEM.get());
    }
