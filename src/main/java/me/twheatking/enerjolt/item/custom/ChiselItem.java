...
import me.twheatking.enerjolt.sound.ModSounds;
...
public class ChiselItem  extends Item {
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        if(CHISEL_MAP.containsKey(clickedBlock)) {
            if(!level.isClientSide()) {
                ...
                context.getItemInHand().set(EnerjoltDataComponentTypes.COORDINATES, context.getClickedPos());
            }
        }
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        ...
        if(stack.get(EnerjoltDataComponentTypes.COORDINATES) != null) {
            tooltipComponents.add(Component.literal("Last Block changed at " + stack.get(EnerjoltDataComponentTypes.COORDINATES)));
        }
