package me.twheatking.enerjolt.loading;
...
@OnlyIn(Dist.CLIENT)
public class EnerjoltBookReloadListener extends SimpleJsonResourceReloadListener {
    private static final Logger LOGGER = LogUtils.getLogger();

    public EnerjoltBookReloadListener() {
