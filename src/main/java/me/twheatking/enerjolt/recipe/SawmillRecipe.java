...
public class SawmillRecipe implements Recipe<RecipeInput> {
    ...
    public SawmillRecipe(ItemStack output, Ingredient input, int sawdustAmount) {
        this(output, new ItemStack(EnerjoltItems.SAWDUST.get(), sawdustAmount), input);
    }
    ...
    public ItemStack getToastSymbol() {
        return new ItemStack(EnerjoltBlocks.SAWMILL_ITEM.get());
    }
    ...
    public static final class Serializer implements RecipeSerializer<SawmillRecipe> {
        ...
        public static final ResourceLocation ID = EJOLTAPI.id("sawmill");
        ...
        private final MapCodec<SawmillRecipe> CODEC = RecordCodecBuilder.mapCodec((instance) -> {
            return instance.group(CodecFix.ITEM_STACK_CODEC.fieldOf("output").forGetter((recipe) -> {
                ...
                return ItemStack.isSameItemSameComponents(recipe.secondaryOutput, new ItemStack(EnerjoltItems.SAWDUST.get()))?
