...
public class AlloyFurnaceMenu extends AbstractContainerMenu {
    ...
    public AlloyFurnaceMenu(int id, Inventory inv, BlockEntity blockEntity, ContainerData data) {
        super(EnerjoltMenuTypes.ALLOY_FURNACE_MENU.get(), id);
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, EnerjoltBlocks.ALLOY_FURNACE.get());
    }
