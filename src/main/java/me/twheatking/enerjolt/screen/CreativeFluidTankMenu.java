...
import me.twheatking.enerjolt.block.entity.CreativeFluidTankBlockEntity;
...
public class CreativeFluidTankMenu extends AbstractContainerMenu {
    ...
    public CreativeFluidTankMenu(int id, Inventory inv, BlockEntity blockEntity) {
        super(EnerjoltMenuTypes.CREATIVE_FLUID_TANK.get(), id);
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, EnerjoltBlocks.CREATIVE_FLUID_TANK.get());
    }
