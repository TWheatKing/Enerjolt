...
import me.twheatking.enerjolt.block.entity.CreativeItemSiloBlockEntity;
import me.twheatking.enerjolt.inventory.*;
...
public class CreativeItemSiloMenu extends AbstractContainerMenu {
    ...
    public CreativeItemSiloMenu(int id, Inventory inv, BlockEntity blockEntity) {
        super(EnerjoltMenuTypes.CREATIVE_ITEM_SILO_MENU.get(), id);
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, EnerjoltBlocks.CREATIVE_ITEM_SILO.get());
    }
