...
import me.twheatking.enerjolt.block.entity.DrainBlockEntity;
import me.twheatking.enerjolt.inventory.data.SimpleProgressValueContainerData;
...
public class DrainMenu extends AbstractContainerMenu {
    ...
    public DrainMenu(int id, Inventory inv, BlockEntity blockEntity, ContainerData data) {
        super(EnerjoltMenuTypes.DRAIN_MENU.get(), id);
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, EnerjoltBlocks.DRAIN.get());
    }
