...
public final class EnerjoltMenuTypes {
    private EnerjoltMenuTypes() {}

    public static final DeferredRegister<MenuType<?>> MENUS = DeferredRegister.create(BuiltInRegistries.MENU, EJOLTAPI.MOD_ID);
