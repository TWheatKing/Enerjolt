...
@OnlyIn(Dist.CLIENT)
public class PhotosyntheticChamberScreen
        extends ConfigurableUpgradableEnergyStorageContainerScreen<PhotosyntheticChamberMenu> {

    public PhotosyntheticChamberScreen(PhotosyntheticChamberMenu menu, Inventory inventory, Component component) {
        super(menu, inventory, component,
                "tooltip.enerjolt.photosynthetic_chamber.energy_required_to_finish.txt",
                EJOLTAPI.id("textures/gui/container/photosynthetic_chamber.png"),
