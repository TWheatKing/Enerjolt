...
public class PressMoldMakerMenu extends AbstractContainerMenu {
    ...
    public PressMoldMakerMenu(int id, Inventory inv, BlockEntity blockEntity) {
        super(EnerjoltMenuTypes.PRESS_MOLD_MAKER_MENU.get(), id);
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, EnerjoltBlocks.PRESS_MOLD_MAKER.get());
    }
