...
import me.twheatking.enerjolt.networking.packet.SetWeatherFromWeatherControllerC2SPacket;
...
public class WeatherControllerScreen
    ...
    public WeatherControllerScreen(WeatherControllerMenu menu, Inventory inventory, Component component) {
        super(menu, inventory, component,
                EJOLTAPI.id("textures/gui/container/weather_controller.png"),
                EJOLTAPI.id("textures/gui/container/upgrade_view/1_duration.png"));
    }
