...
public final class ModStructures {
    ...
    public static void bootstrap(BootstrapContext<Structure> context) {
        ...
        context.register(FACTORY_1, new JigsawStructure(
                new Structure.StructureSettings.Builder(biomes.getOrThrow(EnerjoltBiomeTags.HAS_STRUCTURE_FACTORY_1)).
        ...
        context.register(SMALL_SOLAR_FARM, new JigsawStructure(
                new Structure.StructureSettings.Builder(biomes.getOrThrow(EnerjoltBiomeTags.HAS_STRUCTURE_SMALL_SOLAR_FARM)).
                        terrainAdapation(TerrainAdjustment.BEARD_BOX).
                        generationStep(GenerationStep.Decoration.SURFACE_STRUCTURES).
                        build(),
